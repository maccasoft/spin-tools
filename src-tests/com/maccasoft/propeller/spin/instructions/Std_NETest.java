...
class Std_NETest {
    ...
    void testRegisterRegister() {
        Std_NE factory = new Std_NE(Spin2InstructionObject.encode(0b1001010, 0b10), false);
        ...
        Assertions.assertEquals(
            Spin2InstructionObject.decodeToString(Spin2InstructionObject.encode(0b1001010, 0b10, false, 1, 2)),
    ...
    void testRegisterLiteral() {
        ...
        Assertions.assertEquals(
            Spin2InstructionObject.decodeToString(Spin2InstructionObject.encode(0b1001010, 0b10, true, 1, 2)),
            Spin2InstructionObject.decodeToString(object.getBytes()));
    }
    ...
    @Test
    void testSOptional() {
        Std_NE factory = new Std_NE(Spin2InstructionObject.encode(0b1001010, 0b10), true);
        Spin2InstructionObject object = factory.createObject(new Spin2Context(), Arrays.asList(new Spin2PAsmExpression[] {
            new Spin2PAsmExpression(null, new NumberLiteral(1), null),
        }), null);
        Assertions.assertEquals(
            Spin2InstructionObject.decodeToString(Spin2InstructionObject.encode(0b1001010, 0b10, false, 1, 1)),
            Spin2InstructionObject.decodeToString(object.getBytes()));
    }
