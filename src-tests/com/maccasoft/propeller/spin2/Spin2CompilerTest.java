...
class Spin2CompilerTest {
    ...
    void testIfConditionExpression() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000A 0000A       D0 82          VAR_WRITE LONG DBASE+$00000 (short) (push)\n"
    ...
    void testRepeatRange() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       08             (stack size)\n"
            + "'     repeat a from 1 to 10\n"
            + "00009 00009       45 0F          CONSTANT ($0000F)\n"
            + "0000B 0000B       AB             CONSTANT (10)\n"
            + "0000C 0000C       A2             CONSTANT (1)\n"
            + "0000D 0000D       D0             VAR_LONG DBASE+$00000 (short)\n"
            ...
            + "00013 00013       D0             VAR_LONG DBASE+$00000 (short)\n"
    ...
    void testRepeatRangeStep() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       08             (stack size)\n"
            + "'     repeat a from 1 to 10 step 5\n"
            + "00009 00009       45 10          CONSTANT ($00010)\n"
            + "0000B 0000B       AB             CONSTANT (10)\n"
            + "0000C 0000C       A6             CONSTANT (5)\n"
            + "0000D 0000D       A2             CONSTANT (1)\n"
            + "0000E 0000E       D0             VAR_LONG DBASE+$00000 (short)\n"
            ...
            + "00014 00014       D0             VAR_LONG DBASE+$00000 (short)\n"
    ...
    void testRepeatRangeNext() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0001B 0001B       D0             VAR_LONG DBASE+$00000 (short)\n"
    ...
    void testRepeatRangeQuit() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0001D 0001D       D0             VAR_LONG DBASE+$00000 (short)\n"
    ...
    void testRepeatCaseQuit() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     repeat\n"
            + "'         case a\n"
            + "00009 00009       45 14          CONSTANT ($00014)\n"
            + "0000B 0000B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000C 0000C       A2             CONSTANT (1)\n"
            + "0000D 0000D       1C 01          CASE_JMP $0000F (1)\n"
            + "'             1: quit\n"
            + "0000F 0000F       18 04          POP\n"
            + "00011 00011       12 06          JMP $00018 (6)\n"
            + "00013 00013       1E             CASE_DONE\n"
            + "'         a := 1\n"
            + "00014 00014       A2             CONSTANT (1)\n"
            + "00015 00015       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00016 00016       12 72          JMP $00009 (-14)\n"
    ...
    void testRepeatRangeCaseQuit() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000F 0000F       7D             REPEAT\n"
            + "'         case a\n"
            + "00010 00010       45 1B          CONSTANT ($0001B)\n"
            + "00012 00012       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00013 00013       A2             CONSTANT (1)\n"
            + "00014 00014       1C 01          CASE_JMP $00016 (1)\n"
            + "'             1: quit\n"
            + "00016 00016       18 14          POP\n"
    ...
    void testRepeatNestedCaseQuit() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     repeat\n"
            + "'         case a\n"
            + "00009 00009       45 23          CONSTANT ($00023)\n"
            + "0000B 0000B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000C 0000C       A2             CONSTANT (1)\n"
            + "0000D 0000D       1C 04          CASE_JMP $00012 (4)\n"
            + "0000F 0000F       A3             CONSTANT (2)\n"
            + "00010 00010       1C 06          CASE_JMP $00017 (6)\n"
            + "'             1: quit\n"
            + "00012 00012       18 04          POP\n"
            + "00014 00014       12 12          JMP $00027 (18)\n"
            + "00016 00016       1E             CASE_DONE\n"
            + "'                 case a\n"
            + "00017 00017       45 22          CONSTANT ($00022)\n"
            + "00019 00019       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0001A 0001A       A2             CONSTANT (1)\n"
            + "0001B 0001B       1C 01          CASE_JMP $0001D (1)\n"
            + "'                     1: quit\n"
            + "0001D 0001D       18 0C          POP\n"
            + "0001F 0001F       12 07          JMP $00027 (7)\n"
            + "00021 00021       1E             CASE_DONE\n"
            + "00022 00022       1E             CASE_DONE\n"
            + "'         a := 1\n"
            + "00023 00023       A2             CONSTANT (1)\n"
            + "00024 00024       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00025 00025       12 63          JMP $00009 (-29)\n"
    ...
    void testRepeatRangeNestedCaseQuit() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000F 0000F       7D             REPEAT\n"
            + "'         case a\n"
            + "00010 00010       45 2A          CONSTANT ($0002A)\n"
            + "00012 00012       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00013 00013       A2             CONSTANT (1)\n"
            + "00014 00014       1C 04          CASE_JMP $00019 (4)\n"
            + "00016 00016       A3             CONSTANT (2)\n"
            + "00017 00017       1C 06          CASE_JMP $0001E (6)\n"
            + "'             1: quit\n"
            + "00019 00019       18 14          POP\n"
            + "0001B 0001B       12 12          JMP $0002E (18)\n"
            + "0001D 0001D       1E             CASE_DONE\n"
            + "'                 case a\n"
            + "0001E 0001E       45 29          CONSTANT ($00029)\n"
            + "00020 00020       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00021 00021       A2             CONSTANT (1)\n"
            + "00022 00022       1C 01          CASE_JMP $00024 (1)\n"
            + "'                     1: quit\n"
            + "00024 00024       18 1C          POP\n"
            + "00026 00026       12 07          JMP $0002E (7)\n"
            + "00028 00028       1E             CASE_DONE\n"
            + "00029 00029       1E             CASE_DONE\n"
            + "'         a := 1\n"
            + "0002A 0002A       A2             CONSTANT (1)\n"
            + "0002B 0002B       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "0002C 0002C       D0             VAR_LONG DBASE+$00000 (short)\n"
            + "0002D 0002D       7E             REPEAT_LOOP\n"
            + "0002E 0002E       04             RETURN\n"
            + "0002F 0002F       00             Padding\n"
            + "", compile(text));
    }
    ...
    void testRepeatAddressRange() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0001F 0001F       D0             VAR_LONG DBASE+$00000 (short)\n"
    ...
    void testCase() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       04             (stack size)\n"
            + "'     case a\n"
            + "00009 00009       45 21          CONSTANT ($00021)\n"
            + "0000B 0000B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000C 0000C       A2             CONSTANT (1)\n"
    ...
    void testCaseRange() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       04             (stack size)\n"
            + "'     case a\n"
            + "00009 00009       45 16          CONSTANT ($00016)\n"
            + "0000B 0000B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000C 0000C       A2             CONSTANT (1)\n"
    ...
    void testPostClear() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000C 0000C       D0             VAR_LONG DBASE+$00000 (short)\n"
            + "0000D 0000D       8D             SWAP\n"
            + "0000E 0000E       13 03          JZ $00012 (3)\n"
            + "'         b := 1\n"
            + "00010 00010       A2             CONSTANT (1)\n"
    ...
    void testObjectLink() throws Exception {
        ...
        Assertions.assertEquals(""
            + "00000 00000       14 00 00 00    Object @ $00014\n"
    ...
    void testObjectVariablesLink() throws Exception {
        ...
        Assertions.assertEquals(""
            + "00000 00000       1C 00 00 00    Object @ $0001C\n"
            + "00004 00004       08 00 00 00    Variables @ $00008\n"
            + "00008 00008       2C 00 00 00    Object @ PBASE+$0002C\n"
            + "0000C 0000C       14 00 00 00    Variables @ VBASE+$00014\n"
    ...
    void testObjectMethodCall() throws Exception {
        ...
        Assertions.assertEquals(""
            + "00000 00000       18 00 00 00    Object @ $00018\n"
            + "00004 00004       04 00 00 00    Variables @ $00004\n"
            + "00008 00008       10 00 00 80    Method main @ $00010 (0 parameters, 0 returns)\n"
