...
class Spin2ParserTest {
    ...
    void testStructureMemberBitfield() throws Exception {
        Spin2Parser subject = new Spin2Parser(""
            ...
            + "    STRUCT flags_t(LONG flags.ready[0].error[1].busy[2].done[31])\n"
            + "    STRUCT flags_t(LONG .ready[0] .error[1] .busy[2] .done[31])\n"
            + "    STRUCT flags_t(LONG.ready[0].error[1].busy[2].done[31])\n"
            + "");
        ...
        Assertions.assertEquals(""
            + "RootNode []\n"
            + "+-- ConstantsNode [CON]\n"
            + "    +-- StructNode type=STRUCT identifier=flags_t [STRUCT flags_t(LONG flags .ready[0] .error[1] .busy[2] .done[31])]\n"
            + "        +-- Member type=LONG identifier=flags [LONG flags .ready[0]]\n"
            + "            +-- size = ExpressionNode [0]\n"
            + "        +-- Member identifier=.error [.error[1]]\n"
            + "            +-- size = ExpressionNode [1]\n"
            + "        +-- Member identifier=.busy [.busy[2]]\n"
            + "            +-- size = ExpressionNode [2]\n"
            + "        +-- Member identifier=.done [.done[31]]\n"
            + "            +-- size = ExpressionNode [31]\n"
            + "    +-- StructNode type=STRUCT identifier=flags_t [STRUCT flags_t(LONG flags.ready[0].error[1].busy[2].done[31])]\n"
            + "        +-- Member type=LONG identifier=flags [LONG flags]\n"
            + "        +-- Member identifier=.ready [.ready[0]]\n"
            + "            +-- size = ExpressionNode [0]\n"
            + "        +-- Member identifier=.error [.error[1]]\n"
            + "            +-- size = ExpressionNode [1]\n"
            + "        +-- Member identifier=.busy [.busy[2]]\n"
            ...
            + "        +-- Member identifier=.done [.done[31]]\n"
            + "            +-- size = ExpressionNode [31]\n"
            + "    +-- StructNode type=STRUCT identifier=flags_t [STRUCT flags_t(LONG .ready[0] .error[1] .busy[2] .done[31])]\n"
            + "        +-- Member type=LONG identifier=.ready [LONG .ready[0]]\n"
            + "            +-- size = ExpressionNode [0]\n"
            + "        +-- Member identifier=.error [.error[1]]\n"
            + "            +-- size = ExpressionNode [1]\n"
            + "        +-- Member identifier=.busy [.busy[2]]\n"
