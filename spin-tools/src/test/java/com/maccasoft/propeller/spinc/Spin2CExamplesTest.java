...
class Spin2CExamplesTest {
    ...
    void testPNutBlink() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     for(;;) {\n"
            + "'         pinwrite(addpins(56, 7), getrnd());\n"
            + "00009 00009       44 F8 01       CONSTANT (56 addpins 7)\n"
            + "0000C 0000C       31             GETRND\n"
            + "0000D 0000D       19 A0          PINWRITE\n"
            + "'         waitms(100);\n"
            + "0000F 0000F       42 64          CONSTANT (100)\n"
            + "00011 00011       19 8C          WAITMS\n"
            + "00013 00013       12 75          JMP $00009 (-11)\n"
            + "'     }\n"
            + "' }\n"
    ...
    void testFlexspinBlinkCog() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin2\" header (var size 260)\n"
            ...
            + "00021 00021       37             PINTOGGLE\n"
            + "'         waitms(delay);\n"
            + "00022 00022       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00023 00023       19 8C          WAITMS\n"
