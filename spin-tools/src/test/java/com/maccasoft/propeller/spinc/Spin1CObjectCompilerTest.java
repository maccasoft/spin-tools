...
class Spin1CObjectCompilerTest {
    ...
    void testEmptyFunction() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin1\" header (var size 0)\n"
    ...
    void testGlobalVarAssignment() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin1\" header (var size 12)\n"
    ...
    void testExpressionAssignment() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin1\" header (var size 8)\n"
    ...
    void testMethodCall() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin1\" header (var size 4)\n"
            + "00000 00000       14 00          Object size\n"
    ...
    void testForLoopScopeVariables() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     for(word b1 = 0; b1 < 10; b1++) {\n"
            + "00008 00008       35             CONSTANT (0)\n"
            + "00009 00009       AD 08          VAR_WRITE WORD DBASE+$0008\n"
            + "0000B 0000B       AC 08          VAR_READ WORD DBASE+$0008\n"
            + "0000D 0000D       38 0A          CONSTANT (10)\n"
            + "0000F 0000F       F9             TEST_BELOW\n"
            + "00010 00010       0A 08          JZ $0001A (8)\n"
            + "'         a += 1;\n"
            + "00012 00012       36             CONSTANT (1)\n"
            + "00013 00013       66             VAR_MODIFY LONG DBASE+$0004 (short)\n"
            + "00014 00014       4C             ADD\n"
            + "00015 00015       AE 08          VAR_MODIFY WORD DBASE+$0008\n"
            + "00017 00017       2C             POST_INC\n"
            + "00018 00018       04 71          JMP $0000B (-15)\n"
            + "'     }\n"
            + "'     for(byte b1 = 0; b1 < 10; b1++) {\n"
            + "0001A 0001A       35             CONSTANT (0)\n"
            + "0001B 0001B       8D 08          VAR_WRITE BYTE DBASE+$0008\n"
            + "0001D 0001D       8C 08          VAR_READ BYTE DBASE+$0008\n"
            + "0001F 0001F       38 0A          CONSTANT (10)\n"
            + "00021 00021       F9             TEST_BELOW\n"
            + "00022 00022       0A 09          JZ $0002D (9)\n"
            + "'         a += 2;\n"
            + "00024 00024       37 00          CONSTANT (2)\n"
            + "00026 00026       66             VAR_MODIFY LONG DBASE+$0004 (short)\n"
            + "00027 00027       4C             ADD\n"
            + "00028 00028       8E 08          VAR_MODIFY BYTE DBASE+$0008\n"
            + "0002A 0002A       2A             POST_INC\n"
            + "0002B 0002B       04 70          JMP $0001D (-16)\n"
            + "'     }\n"
            + "' }\n"
    ...
    void testSwitchCaseWithSpinSyntax() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00018 00018       37 22          CONSTANT (7)\n"
            + "0001A 0001A       0D 09          CASE-JMP $00025 (9)\n"
            + "0001C 0001C       37 02          CONSTANT (8)\n"
    ...
    void testStructureArray() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin1\" header (var size 24)\n"
    ...
    void testStructureArrayElementArray() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object \"test.spin1\" header (var size 20)\n"
