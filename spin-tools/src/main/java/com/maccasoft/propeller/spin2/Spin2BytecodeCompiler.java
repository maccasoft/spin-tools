...
public abstract class Spin2BytecodeCompiler extends Spin2PasmCompiler {
        ...
        try {
            ...
            if (ar.length >= 2 && ("BYTE".equalsIgnoreCase(ar[ar.length - 1]) || "WORD".equalsIgnoreCase(ar[ar.length - 1]) || "LONG".equalsIgnoreCase(ar[ar.length - 1]))) {
                ...
                if (expression != null) {
                    ...
                    if (ar[0].startsWith("@")) {
                        source.add(new MemoryOp(context, ss, bb, Bytecode.Op.Address, popIndex, expression, index));
                    }
                        ...
                        if (bitfieldNode != null) {
                            source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, Bytecode.Op.Setup, popIndex, expression, 0));
                        }
                        else {
                            source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, push ? Bytecode.Op.Read : Bytecode.Op.Setup, popIndex, expression, 0));
                        }
                    }
                    else if (expression instanceof NumberLiteral) {
                        source.add(new Constant(context, expression));
                        ...
                        Op op = bitfieldNode == null && postEffectNode == null ? (push ? Bytecode.Op.Read : Bytecode.Op.Write) : Bytecode.Op.Setup;
                    ...
                    if (bitfieldNode != null) {
                        if (postEffectNode != null) {
                            if ("~".equalsIgnoreCase(postEffectNode.getText()) || "~~".equalsIgnoreCase(postEffectNode.getText())) {
                                source.addFirst(new Constant(context, new NumberLiteral("~".equalsIgnoreCase(postEffectNode.getText()) ? 0 : -1)));
                                source.add(new BitField(context, push ? Bytecode.Op.Setup : Bytecode.Op.Write, bitfield));
                                if (push) {
                                    source.add(new Bytecode(context, Spin2Bytecode.bc_var_swap, "SWAP"));
                                }
                            }
                            else {
                                source.add(new BitField(context, Bytecode.Op.Setup, bitfield));
                                if ("++".equalsIgnoreCase(postEffectNode.getText())) {
                                    ...
                                    throw new CompilerException("unsupported post effect", postEffectNode.getToken());
                                }
                            }
                            node.setReturnLongs(push ? 1 : 0);
                        }
                        else {
                            source.add(new BitField(context, Bytecode.Op.Read, bitfield));
                            if (!push) {
                                logMessage(new CompilerException("expecting assignment", node.getTokens()));
                            }
                            node.setReturnLongs(1);
                ...
                if (expression == null && isAbsoluteAddress(node.getText())) {
                    ...
                    if (expression instanceof DataVariable var) {
                ...
                if (expression != null && isStructure(context, expression)) {
                    source.addAll(compileStructure(context, method, node, expression, null, Bytecode.Op.Read, push));
                    return source;
                }
                if (expression == null && ar.length > 1) {
                    ...
                    if (structureExpression != null && isStructure(context, structureExpression)) {
                        source.addAll(compileStructure(context, method, node, structureExpression, null, Bytecode.Op.Read, push));
                        return source;
                    }
                }
                ...
                if (expression != null) {
                    if (expression instanceof ObjectIdentifier) {
                    ...
                    else if (expression instanceof Method methodExpression) {
                        ...
                        if (isAddress(node.getText())) {
                            ...
                            if ((node.getText().startsWith("@[") || node.getText().startsWith("@@[")) && node.getText().endsWith("]")) {
                                ...
                                if (node.getText().startsWith("@@")) {
                                    source.add(new VariableOp(context, Bytecode.Op.Read, popIndex, var, hasIndex, index));
                                    source.add(new Bytecode(context, new byte[] { Spin2Bytecode.bc_add_pbase }, "ADD PBASE"));
                                }
                                else {
                                    source.add(new VariableOp(context, Bytecode.Op.Address, popIndex, var, hasIndex, index));
                                }
                            }
                            else {
                                if (n < node.getChildCount() && (node.getChild(n) instanceof Spin2StatementNode.Index)) {
                                ...
                                if (isPointer(expression)) {
                                    ...
                                    source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, Bytecode.Op.Address, indexNode != null));
                                }
                                else {
                                    if (indexNode != null) {
                                        popIndex = true;
                        ...
                        if (isAddress(node.getText())) {
                            ...
                            if (isAbsoluteAddress(node.getText())) {
                                source.add(new MemoryOp(context, ss, bb, Bytecode.Op.Read, popIndex, expression, index));
                            ...
                            source.add(new MemoryOp(context, Bytecode.Size.Long, Bytecode.Base.PBase, Bytecode.Op.Read, expression));
                            if (!push) {
                                logMessage(new CompilerException("expecting assignment", node.getTokens()));
                            }
                            node.setReturnLongs(1);
            ...
            if (node.isMethod()) {
                ...
                if (desc != null) {
                    ...
                    if (expression instanceof Method) {
                        ...
                        source.addAll(compileVariableRead(context, method, expression, methodNode, true));
                    }
                    ...
                    if (n < node.getChildCount() && (node.getChild(n) instanceof Spin2StatementNode.Index)) {
                        ...
                        source.add(new MemoryOp(context, Bytecode.Size.Long, Bytecode.Base.Pop, Bytecode.Op.Read, indexNode != null));
                        source.add(new Bytecode(context, new byte[] {
                    ...
                    source.add(new Constant(context, new NumberLiteral(getOffsetOf(context, node.getChild(0)))));
                    if (!push) {
                        logMessage(new CompilerException("expecting assignment", node.getTokens()));
                    }
                    node.setReturnLongs(1);
            ...
            if ("CLKMODE".equalsIgnoreCase(node.getText()) || "^@CLKMODE".equalsIgnoreCase(node.getText()) || "CLKFREQ".equalsIgnoreCase(node.getText())) {
                ...
                Size ss = Bytecode.Size.Long;
                Op op = bitfieldNode == null && postEffectNode == null ? (push ? (field ? Bytecode.Op.Field : Bytecode.Op.Read) : Bytecode.Op.Write) : Bytecode.Op.Setup;
                ...
                if (bitfieldNode != null) {
                    if (postEffectNode != null) {
                        ...
                        source.add(new BitField(context, field ? Bytecode.Op.Field : Bytecode.Op.Read, bitfield));
                        if (!push) {
                            logMessage(new CompilerException("expecting assignment", node.getTokens()));
                        }
                        node.setReturnLongs(1);
            ...
            if (":=".equals(node.getText())) {
                ...
                if (node.getChild(0).getChildCount() == 0 && node.getChild(1).getChildCount() == 0) {
                    ...
                    if (isStructure(context, left) && isStructure(context, right)) {
                        ...
                        List<Spin2Bytecode> leftSource = compileStructure(context, method, node.getChild(0), left, null, Bytecode.Op.Address, true);
                        ...
                        List<Spin2Bytecode> rightSource = compileStructure(context, method, node.getChild(1), right, null, Bytecode.Op.Address, true);
            ...
            if ("[++]".equals(node.getText()) || "[--]".equals(node.getText())) {
                ...
                if (isStructure(context, expression)) {
                    source.addAll(compileStructure(context, method, childNode, expression, node, Bytecode.Op.Read, push));
            ...
            if ("++".equalsIgnoreCase(node.getText()) || "--".equalsIgnoreCase(node.getText()) || "??".equalsIgnoreCase(node.getText())) {
                ...
                if (s.length == 2 && ("BYTE".equalsIgnoreCase(s[1]) || "WORD".equalsIgnoreCase(s[1]) || "LONG".equalsIgnoreCase(s[1]))) {
                    ...
                    source.add(new MemoryOp(context, ss, bb, Bytecode.Op.Setup, indexNode != null, expression, 0));
                    ...
                    source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, Bytecode.Op.Setup, indexNode != null));
                    ...
                    if (isStructure(context, expression)) {
                        source.addAll(compileStructure(context, method, expressionNode, expression, pointerPreEffectNode, Bytecode.Op.Setup, true));
                    ...
                    if (expressionNode.getText().startsWith("[")) {
                        ...
                        try {
                            if (typeSize <= 33) {
                                os.write(Spin2Bytecode.bc_set_incdec_2_33 + typeSize - 2);
                            }
                            else {
            ...
            if ("BYTE".equalsIgnoreCase(node.getText()) || "WORD".equalsIgnoreCase(node.getText()) || "LONG".equalsIgnoreCase(node.getText())
                ...
                if (node.getText().startsWith("@@")) {
                    source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, Bytecode.Op.Read, indexNode != null));
                    source.add(new Bytecode(context, Spin2Bytecode.bc_add_pbase, "ADD_PBASE"));
                }
                else if (node.getText().startsWith("@")) {
                    source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, Bytecode.Op.Address, indexNode != null));
            ...
            if ("REG".equalsIgnoreCase(node.getText())) {
                ...
                Bytecode.Op op = bitfieldNode == null && postEffectNode == null ? (push ? Bytecode.Op.Read : Bytecode.Op.Write) : Bytecode.Op.Setup;
    ...
    protected Expression buildConstantExpression(Context context, Spin2StatementNode node, boolean registerConstant) {
        ...
        switch (nodeText.toUpperCase()) {
            ...
            case "OFFSETOF":
                if (node.getChildCount() == 1) {
                    return new NumberLiteral(getOffsetOf(context, node.getChild(0)));
                }
                throw new RuntimeException("expected type or variable (" + node.getText() + ")");
        }
    ...
    int getOffsetOf(Context context, Spin2StatementNode node) {
        ...
        if (struct == null) {
            logMessage(new CompilerException("expecting structure", node.getTokens()));
            return 0;
        }

        return getOffsetOf(context, struct, node);
    }

    int getOffsetOf(Context context, Spin2Struct struct, Spin2StatementNode node) {
        int offset = 0;
        Spin2Struct.Member member = null;
        String[] identifier = node.getText().split("[.]");

        int index = 1;
        while (index < identifier.length) {
            member = struct.getMember(identifier[index++]);
            if (member == null) {
                logMessage(new CompilerException(CompilerException.ERROR, "expecting structure member", node.getTokens()));
                return offset;
            }
        ...
        if (n < node.getChildCount() && (node.getChild(n) instanceof Spin2StatementNode.Index)) {
            ...
            try {
                Expression exp = buildConstantExpression(context, indexNode);
                if (!exp.isConstant()) {
                    logMessage(new CompilerException("not a constant", indexNode.getTokens()));
                }
                else {
                    int typeSize = 4;
                    if (struct != null) {
                    ...
                    else if (member != null && member.getType() != null) {
                        typeSize = switch (member.getType().getText().toUpperCase()) {
                            case "BYTE" -> 1;
                            case "WORD" -> 2;
                            default -> typeSize;
                        };
                    }
                    offset = exp.getNumber().intValue() * typeSize;
                }
            } catch (Exception e) {
                logMessage(new CompilerException(e.getMessage(), indexNode.getTokens()));
            }
        }
        if (struct != null && n < node.getChildCount()) {
            offset += getOffsetOf(context, struct, node.getChild(n++));
        }
        if (n < node.getChildCount()) {
    ...
    protected List<Spin2Bytecode> leftAssign(Context context, Spin2Method method, Spin2StatementNode node, boolean push, boolean write) {
        ...
        if (ar.length >= 2 && ("BYTE".equalsIgnoreCase(ar[ar.length - 1]) || "WORD".equalsIgnoreCase(ar[ar.length - 1]) || "LONG".equalsIgnoreCase(ar[ar.length - 1]))) {
            ...
            if (isPointer(expression)) {
                ...
                Op op = push ? Bytecode.Op.WritePush : Bytecode.Op.Write;
                if (bitfieldNode != null) {
                    op = Bytecode.Op.Setup;
                }
                source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, op, indexNode != null, expression, 0));
            }
            else {
                if (popIndex) {
                    source.addAll(compileBytecodeExpression(context, method, indexNode, true));
                ...
                if (expression instanceof NumberLiteral) {
                    ...
                    if (push && write) {
                        ...
                        Op op = push || bitfieldNode != null ? Bytecode.Op.Setup : Bytecode.Op.Write;
                        source.add(new MemoryOp(context, ss, bb, op, popIndex, expression, index));
                    }
                }
            }
            ...
            if (bitfieldNode != null) {
                if (postEffectNode != null) {
                    ...
                    source.add(new BitField(context, Bytecode.Op.Write, bitfield));
                }
            }
            else {
                if (postEffectNode != null) {
            ...
            if (isStructure(context, expression)) {
                source.addAll(compileStructure(context, method, node.getChild(0), expression, node, push ? Bytecode.Op.Setup : Bytecode.Op.Write, push));
                node.setReturnLongs(node.getChild(0).getReturnLongs());
                if (write) {
                ...
                source.add(new VariableOp(context, Bytecode.Op.Setup, popIndex, var, hasIndex, index));
                if ("[++]".equals(node.getText())) {
                ...
                if (bitfieldNode != null) {
                    source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, Bytecode.Op.Setup, indexNode != null));
                    source.add(new BitField(context, Op.Write, bitfield));
                }
                else {
                    source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, push ? Bytecode.Op.WritePush : Bytecode.Op.Write, indexNode != null));
                }
            ...
            if (isStructure(context, expression)) {
                source.addAll(compileStructure(context, method, node, expression, null, push ? Bytecode.Op.Setup : Bytecode.Op.Write, push));
                if (write) {
                    if (node.getReturnLongs() != 1) {
                ...
                if (node.getText().startsWith("[")) {
                    ...
                    source.add(new VariableOp(context, push ? Bytecode.Op.Setup : Bytecode.Op.Write, popIndex, var, hasIndex, index));
                    if (write) {
                        source.add(new Bytecode(context, Spin2Bytecode.bc_write_push, "WRITE (push)"));
                    }
                }
                    ...
                    if (pointerPostEffectNode != null) {
                        ...
                        if ("[++]".equalsIgnoreCase(pointerPostEffectNode.getText())) {
                            ...
                            throw new CompilerException("invalid post effect", pointerPostEffectNode.getTokens());
                        }
                        source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, write ? Bytecode.Op.WritePush : Bytecode.Op.Write, indexNode != null));
                    }
                    else {
                        source.add(new VariableOp(context, Bytecode.Op.Read, popIndex, var, hasIndex, index));
                        if (indexNode != null) {
                        ...
                        if (push && !write) {
                            ...
                            op = push ? Bytecode.Op.WritePush : Bytecode.Op.Write;
                        }
                        source.add(new MemoryOp(context, ss, Bytecode.Base.Pop, op, indexNode != null));
                    }
                }
                ...
                if (expression instanceof Register) {
                    ...
                    source.add(new MemoryOp(context, ss, bb, bitfieldNode != null || push ? Bytecode.Op.Setup : Bytecode.Op.Write, popIndex, expression, index));
                }
                else if (expression instanceof Variable) {
                    source.add(new VariableOp(context, bitfieldNode != null || push ? Bytecode.Op.Setup : Bytecode.Op.Write, popIndex, (Variable) expression, hasIndex, index));
                    ((Variable) expression).setCalledBy(method);
                }
                else {
        ...
        if (symbol instanceof ObjectIdentifier) {
            ...
            if (symbol instanceof Method) {
                ...
                if (isStructure(context, symbol)) {
                    ...
                    source.addAll(compileStructure(context, method, node, symbol, null, Bytecode.Op.Read, true));
                    ...
                    source.add(new VariableOp(context, Bytecode.Op.Read, popIndex, (Variable) symbol, hasIndex, index));
                    ...
                    source.add(new MemoryOp(context, Bytecode.Size.Long, Bytecode.Base.PBase, Bytecode.Op.Read, popIndex, symbol, index));
                }
                else {
    ...
    List<Spin2Bytecode> compileVariableSetup(Context context, Spin2Method method, Expression expression, Spin2StatementNode node, Spin2StatementNode pointerPreEffectNode) {
        ...
        if (isPointer(expression)) {
            ...
            if (bitfieldNode != null) {
                ...
                if (expression instanceof Register) {
                    source.add(new RegisterOp(context, Bytecode.Op.Setup, popIndex, expression, index));
                }
                else if (expression instanceof ContextLiteral) {
                    source.add(new MemoryOp(context, ss, bb, Bytecode.Op.Setup, popIndex, expression, index));
                }
    ...
    List<Spin2Bytecode> compileVariableRead(Context context, Spin2Method method, Expression expression, Spin2StatementNode node, Spin2StatementNode pointerPreEffectNode, boolean push) {
        ...
        if (isStructure(context, expression)) {
            source.addAll(compileStructure(context, method, node, expression, pointerPreEffectNode, Bytecode.Op.Read, push));
        }
        else if (isPointer(expression)) {
            int n = 0;
            if (n < node.getChildCount()) {
            ...
            if (n < node.getChildCount()) {
                ...
                if (".byte".equals(child.getText()) || ".word".equals(child.getText()) || ".long".equals(child.getText())) {
                    ...
                    int on = 0;
                    if (on < typeOverrideNode.getChildCount() && isPostEffect(typeOverrideNode.getChild(on))) {
                        postEffectNode = typeOverrideNode.getChild(on++);
                    }
                    if (on < typeOverrideNode.getChildCount()) {
                        throw new CompilerException("unexpected: " + typeOverrideNode.getChild(on).getText(), typeOverrideNode.getChild(on).getTokens());
                    }
                }
            }
            if (typeOverrideNode == null) {
            ...
            if (node.getText().startsWith("[") && node.getText().endsWith("]")) {
                if (postEffectNode != null) {
                    if ("++".equalsIgnoreCase(postEffectNode.getText()) || "--".equalsIgnoreCase(postEffectNode.getText())) {
                        source.add(new VariableOp(context, Bytecode.Op.Setup, false, var, false, index));
                        ByteArrayOutputStream os = new ByteArrayOutputStream();
                        try {
                            if (typeSize >= 2) {
                                os.write(Spin2Bytecode.bc_set_incdec_2_33 + typeSize - 2);
                    ...
                    source.add(new VariableOp(context, Bytecode.Op.Read, false, var, false, index));
                    if (!push) {
                        logMessage(new CompilerException("expecting assignment", node.getTokens()));
                    }
                }
                ...
                if (pointerPreEffectNode != null) {
                    ...
                    if ("[++]".equalsIgnoreCase(pointerPreEffectNode.getText())) {
                        ...
                        throw new CompilerException("unsupported pointer pre effect", pointerPreEffectNode.getTokens());
                    }
                    ...
                    if ("[++]".equalsIgnoreCase(pointerPostEffectNode.getText())) {
                        ...
                        throw new CompilerException("unsupported pointer post effect", pointerPostEffectNode.getTokens());
                    }
                    ...
                    if (bitfieldNode != null) {
                        ...
                        if (postEffectNode != null) {
                            ...
                            source.add(new BitField(context, field ? Op.Field : Op.Read, bitfield));
                        }
                    }
            ...
            if (bitfieldNode != null) {
                ...
                if (postEffectNode != null) {
                    if ("~".equalsIgnoreCase(postEffectNode.getText()) || "~~".equalsIgnoreCase(postEffectNode.getText())) {
                        source.addFirst(new Constant(context, new NumberLiteral("~".equalsIgnoreCase(postEffectNode.getText()) ? 0 : -1)));
                        if (expression instanceof Register) {
                            source.add(new RegisterOp(context, push ? Bytecode.Op.Setup : Bytecode.Op.Write, popIndex, expression, index));
                        }
                        else if (expression instanceof ContextLiteral) {
                            source.add(new MemoryOp(context, ss, bb, push ? Bytecode.Op.Setup : Bytecode.Op.Write, popIndex, expression, index));
                        }
                        else {
                            source.add(new VariableOp(context, push ? Bytecode.Op.Setup : Bytecode.Op.Write, popIndex, (Variable) expression, hasIndex, index));
                            ((Variable) expression).setCalledBy(method);
                        }
                        if (push) {
                            source.add(new Bytecode(context, Spin2Bytecode.bc_var_swap, "SWAP"));
                    ...
                    if (expression instanceof Register) {
                        source.add(new RegisterOp(context, field ? Bytecode.Op.Field : Bytecode.Op.Read, popIndex, expression, index));
                    }
                    else if (expression instanceof ContextLiteral) {
        ...
        if ((node.getText().startsWith("@[") || node.getText().startsWith("@@[")) && node.getText().endsWith("]")) {
            ...
            if (pointerPostEffectNode != null) {
                ...
                if ("++".equalsIgnoreCase(pointerPostEffectNode.getText()) || "--".equalsIgnoreCase(pointerPostEffectNode.getText())) {
                    ...
                    try {
                        ...
                        if (structSize >= 2) {
                            if (structSize <= 33) {
                                os.write(Spin2Bytecode.bc_set_incdec_2_33 + structSize - 2);
                            }
                            else {
                                os.write(Spin2Bytecode.bc_set_incdec_rfvar);
            ...
            while (struct != null) {
                ...
                while (i < ar.length) {
                    ...
                    if (member.hasBitfields() && i < ar.length) {
                        member = struct.getMember(ar[i++]);
                        if (member == null) {
                            throw new CompilerException("undefined symbol " + varNode.getText(), varNode.getToken());
                        }
                    }
            ...
            if (struct != null || !indexNodes.isEmpty() || postEffectNode != null || pointerPostEffectNode != null || bb == Bytecode.Base.Pop) {
                ...
                if (bitfieldNode != null || bitfield != -1) {
                    source.add(new StructOp(context, Bytecode.Op.Setup, bb, ss, struct, expression, index + offset, indexMultipliers, push));
                    if (postEffectNode != null) {
                        if ("~".equalsIgnoreCase(postEffectNode.getText()) || "~~".equalsIgnoreCase(postEffectNode.getText())) {
                            source.addFirst(new Constant(context, new NumberLiteral("~".equalsIgnoreCase(postEffectNode.getText()) ? 0 : -1)));
                            source.add(new BitField(context, push ? Bytecode.Op.Setup : Bytecode.Op.Write, bitfield));
                    ...
                    if (postEffectNode != null) {
                        ...
                        if (struct != null) {
                            ...
                            try {
                                ...
                                if (!"~".equalsIgnoreCase(postEffectNode.getText()) && !"~~".equalsIgnoreCase(postEffectNode.getText())) {
                                    logMessage(new CompilerException("invalid post effect", postEffectNode.getToken()));
                                }
                                os.write(Spin2Bytecode.bc_con_n1_14 + ("~".equalsIgnoreCase(postEffectNode.getText()) ? 1 : 0));
                        ...
                        source.add(new StructOp(context, op, bb, ss, struct, expression, index + offset, indexMultipliers, push));
                    }
                }
                ...
                if (expression instanceof Variable && "LONG".equalsIgnoreCase(varType) && ((index + offset) % 4) == 0) {
                    source.add(new VariableOp(context, bitfieldNode != null || bitfield != -1 ? Op.Setup : op, false, (Variable) expression, false, (index + offset) / 4));
                }
                else {
                    source.add(new MemoryOp(context, ss, bb, bitfieldNode != null || bitfield != -1 ? Op.Setup : op, expression, index + offset));
                }
                if (bitfieldNode != null || bitfield != -1) {
                    source.add(new BitField(context, op == Bytecode.Op.Read ? Bytecode.Op.Read : Bytecode.Op.Write, bitfield));
                }
            }
            ...
            if (varNode.isMethod()) {
                ...
                if (op == Op.Read && !push && pointerPreEffectNode == null && pointerPostEffectNode == null) {
                    logMessage(new CompilerException("expecting assignment", node.getTokens()));
                }
            }
