...
public class Getnib extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.D_S_N.check(arguments, effect)) {
            return new Getnib_(context, condition, arguments.get(0), arguments.get(1), arguments.get(2));
        }
        if (Spin2PAsmSchema.D_WC_WZ_WCZ.check(arguments, effect)) {
            return new Getnib_D_(context, condition, arguments.get(0));
        }
     ...
     * GETNIB  D,{#}S,#N
     */
    public class Getnib_ extends Spin2InstructionObject {
        ...
        public Getnib_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, Spin2PAsmExpression n) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            try {
                ...
                value = nnn.setValue(value, count);
            } catch (CompilerException e) {
                msgs.addMessage(e);
            } catch (Exception e) {
     ...
     * GETNIB  D
     */
    public class Getnib_D_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Getnib_D_(Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
