...
public class Qfrac extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_S.check(arguments, effect)) {
            return new Qfrac_(context, condition, arguments.get(0), arguments.get(1));
        }
     ...
     * QFRAC   {#}D,{#}S
     */
    public class Qfrac_ extends Spin2InstructionObject {
        ...
        public Qfrac_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            int value = o.setValue(encodeInstructionParameters(condition, dst, src), 0b1101001);
