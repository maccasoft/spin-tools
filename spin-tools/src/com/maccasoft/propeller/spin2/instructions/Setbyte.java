...
public class Setbyte extends Spin2PAsmInstructionFactory {
    ...
    public class Setbyte_ extends Spin2InstructionObject {
        ...
        public Setbyte_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, Spin2PAsmExpression n) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            try {
                if (n.getInteger() < 0 || n.getInteger() > 3) {
                    msgs.addMessage(new CompilerException("selector must be 0 to 3", n.getExpression().getData()));
                }
    ...
    public class Setbyte_S_ extends Spin2InstructionObject {
        ...
        public Setbyte_S_(Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.src = dst;
        }
