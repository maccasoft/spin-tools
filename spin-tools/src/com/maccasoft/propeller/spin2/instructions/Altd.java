...
public class Altd extends Spin2PAsmInstructionFactory {
    ...
    public class Altd_ extends Spin2InstructionObject {
        ...
        public Altd_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altd_D_ extends Spin2InstructionObject {
        ...
        public Altd_D_(Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
