...
public class Xzero extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_S.check(arguments, effect)) {
            return new Xzero_(context, condition, arguments.get(0), arguments.get(1));
        }
     ...
     * XZERO   {#}D,{#}S
     */
    public class Xzero_ extends Spin2InstructionObject {
        ...
        public Xzero_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
