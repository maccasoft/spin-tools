...
public class Altgn extends Spin2PAsmInstructionFactory {
    ...
    public class Altgn_ extends Spin2InstructionObject {
        ...
        public Altgn_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altgn_D_ extends Spin2InstructionObject {
        ...
        public Altgn_D_(Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
