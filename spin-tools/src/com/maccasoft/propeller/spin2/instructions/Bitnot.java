...
public class Bitnot extends Spin2PAsmInstructionFactory {
    ...
    public class Bitnot_ extends Spin2InstructionObject {
        ...
        public Bitnot_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            int value = o.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b0100111);
