...
public class Xinit extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_S.check(arguments, effect)) {
            return new Xinit_(context, condition, arguments.get(0), arguments.get(1));
        }
     ...
     * XINIT   {#}D,{#}S
     */
    public class Xinit_ extends Spin2InstructionObject {
        ...
        public Xinit_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            int value = o.setValue(encodeInstructionParameters(condition, dst, src), 0b1100101);
