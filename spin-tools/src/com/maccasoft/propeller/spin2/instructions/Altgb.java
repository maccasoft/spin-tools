...
public class Altgb extends Spin2PAsmInstructionFactory {
    ...
    public class Altgb_ extends Spin2InstructionObject {
        ...
        public Altgb_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altgb_D_ extends Spin2InstructionObject {
        ...
        public Altgb_D_(Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
