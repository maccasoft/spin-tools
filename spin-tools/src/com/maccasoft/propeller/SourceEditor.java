    ...
    void doTab() {
        ...
        if (editorSelection.x != editorSelection.y) {
            ...
            do {
                ...
                index = text.indexOf(styledText.getLineDelimiter(), index);
                if (index != -1) {
                    index += styledText.getLineDelimiter().length();
                }
    ...
    void doBacktab() {
        ...
        if (editorSelection.x != editorSelection.y) {
            ...
            do {
                ...
                index = text.indexOf(styledText.getLineDelimiter(), index - spaces);
                if (index != -1) {
                    index += styledText.getLineDelimiter().length();
                }
