...
class Spin2CObjectCompilerTest {
    ...
    void testInlinePAsmBlock() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     }\n"
            + "'     asm {\n"
            + "00017 00017       19 5C          INLINE-EXEC\n"
            + "00019 00019       00 00 01 00    ORG=$000, 2\n"
            + "0001D 0001D   000                                    org\n"
            + "0001D 0001D   000 00 00 00 00                        nop\n"
            + "00021 00021   001 2D 00 64 FD                        ret\n"
            + "'     }\n"
            + "'     asm {\n"
            + "00025 00025       19 5E          INLINE-EXEC\n"
            + "00027 00027       00 00 01 00    ORGH=$000, 2\n"
            + "0002B 0002B   000                                    orgh\n"
            + "0002B 0002B   000 00 00 00 00                        nop\n"
            + "0002F 0002F   004 2D 00 64 FD                        ret\n"
            + "'     }\n"
            + "' }\n"
    ...
    void testFloatExpression() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0001C 0001C       19 C2          FLOAT_MULTIPLY\n"
