...
class Spin2CObjectCompilerTest {
    ...
    void testForLoopScopeVariables() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     for(word b1 = 0; b1 < 10; b1++) {\n"
            + "00009 00009       A1             CONSTANT (0)\n"
            + "0000A 0000A       57 04 81       VAR_WRITE WORD DBASE+$00004\n"
            + "0000D 0000D       57 04 80       VAR_READ WORD DBASE+$00004\n"
            ...
            + "0001D 0001D       51 04 81       VAR_WRITE BYTE DBASE+$00004\n"
            + "00020 00020       51 04 80       VAR_READ BYTE DBASE+$00004\n"
            ...
            + "00029 00029       A3             ADD_ASSIGN\n"
            + "0002A 0002A       51 04          VAR_SETUP BYTE DBASE+$00004\n"
            + "0002C 0002C       83             POST_INC\n"
    ...
    void testFloatAssignment() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00018 00018       C2 81          VAR_WRITE FLOAT VBASE+$00002 (short)\n"
            + "'     d = 4.0;\n"
