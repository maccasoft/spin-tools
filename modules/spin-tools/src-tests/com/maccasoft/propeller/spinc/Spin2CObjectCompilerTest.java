...
class Spin2CObjectCompilerTest {
    ...
    void testStructure() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     s.a = a;\n"
            + "00009 00009       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000A 0000A       50 04 81       VAR_WRITE BYTE VBASE+$00004\n"
            + "'     s.b = a;\n"
            + "0000D 0000D       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000E 0000E       56 05 81       VAR_WRITE WORD VBASE+$00005\n"
            + "'     s.c = a;\n"
            + "00011 00011       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00012 00012       56 07 81       VAR_WRITE WORD VBASE+$00007\n"
            + "'     s.d = a;\n"
            + "00015 00015       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00016 00016       5C 09 81       VAR_WRITE LONG VBASE+$00009\n"
            + "'     a = s.a;\n"
            + "00019 00019       50 04 80       VAR_READ BYTE VBASE+$00004\n"
            + "0001C 0001C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s.b;\n"
            + "0001D 0001D       56 05 80       VAR_READ WORD VBASE+$00005\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s.c;\n"
            + "00021 00021       56 07 80       VAR_READ WORD VBASE+$00007\n"
            + "00024 00024       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s.d;\n"
            + "00025 00025       5C 09 80       VAR_READ LONG VBASE+$00009\n"
    ...
    void testStructureArray() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000B 0000B       50 04 7F       VAR_ADDRESS VBASE+$00004\n"
            + "0000E 0000E       8A             ADD (push)\n"
            + "0000F 0000F       61 81          MEM_WRITE BYTE\n"
            + "'     s[1].b = a;\n"
            + "00011 00011       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00012 00012       AA             CONSTANT (1 * 9)\n"
            + "00013 00013       56 05 7F       VAR_ADDRESS VBASE+$00005\n"
            + "00016 00016       8A             ADD (push)\n"
            + "00017 00017       62 81          MEM_WRITE WORD\n"
            + "'     s[1].c = a;\n"
            + "00019 00019       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0001A 0001A       AA             CONSTANT (1 * 9)\n"
            + "0001B 0001B       56 07 7F       VAR_ADDRESS VBASE+$00007\n"
            + "0001E 0001E       8A             ADD (push)\n"
            + "0001F 0001F       62 81          MEM_WRITE WORD\n"
            + "'     s[1].d = a;\n"
            + "00021 00021       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00022 00022       AA             CONSTANT (1 * 9)\n"
            + "00023 00023       5C 09 7F       VAR_ADDRESS VBASE+$00009\n"
            + "00026 00026       8A             ADD (push)\n"
            + "00027 00027       63 81          MEM_WRITE LONG\n"
            + "'     a = s[1].a;\n"
            + "00029 00029       AA             CONSTANT (1 * 9)\n"
            + "0002A 0002A       50 04 7F       VAR_ADDRESS VBASE+$00004\n"
            + "0002D 0002D       8A             ADD (push)\n"
            + "0002E 0002E       61 80          MEM_READ BYTE\n"
            + "00030 00030       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s[1].b;\n"
            + "00031 00031       AA             CONSTANT (1 * 9)\n"
            + "00032 00032       56 05 7F       VAR_ADDRESS VBASE+$00005\n"
            + "00035 00035       8A             ADD (push)\n"
            + "00036 00036       62 80          MEM_READ WORD\n"
            + "00038 00038       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s[1].c;\n"
            + "00039 00039       AA             CONSTANT (1 * 9)\n"
            + "0003A 0003A       56 07 7F       VAR_ADDRESS VBASE+$00007\n"
            + "0003D 0003D       8A             ADD (push)\n"
            + "0003E 0003E       62 80          MEM_READ WORD\n"
            + "00040 00040       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s[1].d;\n"
            + "00041 00041       AA             CONSTANT (1 * 9)\n"
            + "00042 00042       5C 09 7F       VAR_ADDRESS VBASE+$00009\n"
            + "00045 00045       8A             ADD (push)\n"
            + "00046 00046       63 80          MEM_READ LONG\n"
    ...
    void testStructureElementArray() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     s.b[1] = a;\n"
            + "00011 00011       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00012 00012       56 07 81       VAR_WRITE WORD VBASE+$00005\n"
            + "'     a = s.a;\n"
            + "00015 00015       50 04 80       VAR_READ BYTE VBASE+$00004\n"
            + "00018 00018       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s.b[0];\n"
            + "00019 00019       56 05 80       VAR_READ WORD VBASE+$00005\n"
            + "0001C 0001C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s.b[1];\n"
            + "0001D 0001D       56 07 80       VAR_READ WORD VBASE+$00005\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "' }\n"
            + "00021 00021       04             RETURN\n"
            + "00022 00022       00 00          Padding\n"
    ...
    void testStructureArrayElementArray() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     s[2].a = a;\n"
            + "00009 00009       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000A 0000A       42 12          CONSTANT (2 * 9)\n"
            + "0000C 0000C       50 04 7F       VAR_ADDRESS VBASE+$00004\n"
            + "0000F 0000F       8A             ADD (push)\n"
            + "00010 00010       61 81          MEM_WRITE BYTE\n"
            + "'     s[2].b[0] = a;\n"
            + "00012 00012       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00013 00013       42 12          CONSTANT (2 * 9)\n"
            + "00015 00015       56 05 7F       VAR_ADDRESS VBASE+$00005\n"
            + "00018 00018       8A             ADD (push)\n"
            + "00019 00019       A1             CONSTANT (0)\n"
            + "0001A 0001A       65 81          MEM_WRITE WORD INDEXED\n"
            + "'     s[2].b[1] = a;\n"
            + "0001C 0001C       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0001D 0001D       42 12          CONSTANT (2 * 9)\n"
            + "0001F 0001F       56 05 7F       VAR_ADDRESS VBASE+$00005\n"
            + "00022 00022       8A             ADD (push)\n"
            + "00023 00023       A2             CONSTANT (1)\n"
            + "00024 00024       65 81          MEM_WRITE WORD INDEXED\n"
            + "'     a = s[2].a;\n"
            + "00026 00026       42 12          CONSTANT (2 * 9)\n"
            + "00028 00028       50 04 7F       VAR_ADDRESS VBASE+$00004\n"
            + "0002B 0002B       8A             ADD (push)\n"
            + "0002C 0002C       61 80          MEM_READ BYTE\n"
            + "0002E 0002E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s[2].b[0];\n"
            + "0002F 0002F       42 12          CONSTANT (2 * 9)\n"
            + "00031 00031       56 05 7F       VAR_ADDRESS VBASE+$00005\n"
            + "00034 00034       8A             ADD (push)\n"
            + "00035 00035       A1             CONSTANT (0)\n"
            + "00036 00036       65 80          MEM_READ WORD INDEXED\n"
            + "00038 00038       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a = s[2].b[1];\n"
            + "00039 00039       42 12          CONSTANT (2 * 9)\n"
            + "0003B 0003B       56 05 7F       VAR_ADDRESS VBASE+$00005\n"
            + "0003E 0003E       8A             ADD (push)\n"
            + "0003F 0003F       A2             CONSTANT (1)\n"
            + "00040 00040       65 80          MEM_READ WORD INDEXED\n"
