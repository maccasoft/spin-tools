...
class Spin2ObjectCompilerTest {
    ...
    void testStructureAssignments() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     line.a.x := 2\n"
            + "0000C 0000C       A3             CONSTANT (2)\n"
            + "0000D 0000D       C3 81          VAR_WRITE LONG VBASE+$00003 (short)\n"
            + "'     line.a.y := 3\n"
            + "0000F 0000F       A4             CONSTANT (3)\n"
            + "00010 00010       C4 81          VAR_WRITE LONG VBASE+$00004 (short)\n"
            + "'     line.b.x := 4\n"
            + "00012 00012       A5             CONSTANT (4)\n"
            + "00013 00013       C5 81          VAR_WRITE LONG VBASE+$00005 (short)\n"
            + "'     line.b.y := 5\n"
            + "00015 00015       A6             CONSTANT (5)\n"
            + "00016 00016       C6 81          VAR_WRITE LONG VBASE+$00006 (short)\n"
            + "'     line.color := 6\n"
            + "00018 00018       A7             CONSTANT (6)\n"
            + "00019 00019       52 1C 81       VAR_WRITE BYTE VBASE+$0001C\n"
            + "0001C 0001C       04             RETURN\n"
            + "0001D 0001D       00 00 00       Padding\n"
            + "", compile(text));
    }
    ...
    void testStructureRead() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000B 0000B       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.x\n"
            + "0000C 0000C       C3 80          VAR_READ LONG VBASE+$00003 (short)\n"
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y\n"
            + "0000F 0000F       C4 80          VAR_READ LONG VBASE+$00004 (short)\n"
            + "00011 00011       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.b.x\n"
            + "00012 00012       C5 80          VAR_READ LONG VBASE+$00005 (short)\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.b.y\n"
            + "00015 00015       C6 80          VAR_READ LONG VBASE+$00006 (short)\n"
            + "00017 00017       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.color\n"
            + "00018 00018       52 1C 80       VAR_READ BYTE VBASE+$0001C\n"
            + "0001B 0001B       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "0001C 0001C       04             RETURN\n"
            + "0001D 0001D       00 00 00       Padding\n"
            + "", compile(text));
    ...
    void testStructureArrayRead() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000B 0000B       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[0].a.x\n"
            + "0000C 0000C       5E 04 80       MEM_READ LONG VBASE+$00004\n"
            + "0000F 0000F       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y\n"
            + "00010 00010       C2 80          VAR_READ LONG VBASE+$00002 (short)\n"
            + "00012 00012       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[0].a.y\n"
            + "00013 00013       5E 08 80       MEM_READ LONG VBASE+$00008\n"
            + "00016 00016       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[1].a.x\n"
            + "00017 00017       5E 15 80       MEM_READ LONG VBASE+$00015\n"
            + "0001A 0001A       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[1].a.y\n"
            + "0001B 0001B       5E 19 80       MEM_READ LONG VBASE+$00019\n"
            + "0001E 0001E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[b].a.x\n"
            + "0001F 0001F       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00020 00020       44 11          CONSTANT (17)\n"
            + "00022 00022       96             MULTIPLY\n"
            + "00023 00023       A5             CONSTANT (4)\n"
            + "00024 00024       8A             ADD\n"
            + "00025 00025       68 80          MEM_READ LONG\n"
            + "00027 00027       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[b + 1].a.y\n"
            + "00028 00028       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00029 00029       A2             CONSTANT (1)\n"
            + "0002A 0002A       8A             ADD\n"
            + "0002B 0002B       44 11          CONSTANT (17)\n"
            + "0002D 0002D       96             MULTIPLY\n"
            + "0002E 0002E       A9             CONSTANT (8)\n"
            + "0002F 0002F       8A             ADD\n"
            + "00030 00030       68 80          MEM_READ LONG\n"
            + "00032 00032       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructureArrayAssignment() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     line[0].a.x := a\n"
            + "0000C 0000C       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0000D 0000D       5E 04 81       MEM_WRITE LONG VBASE+$00004\n"
            + "'     line.a.y := a\n"
            + "00010 00010       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00011 00011       C2 81          VAR_WRITE LONG VBASE+$00002 (short)\n"
            + "'     line[0].a.y := a\n"
            + "00013 00013       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00014 00014       5E 08 81       MEM_WRITE LONG VBASE+$00008\n"
            + "'     line[1].a.x := a\n"
            + "00017 00017       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00018 00018       5E 15 81       MEM_WRITE LONG VBASE+$00015\n"
            + "'     line[1].a.y := a\n"
            + "0001B 0001B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0001C 0001C       5E 19 81       MEM_WRITE LONG VBASE+$00019\n"
            + "0001F 0001F       04             RETURN\n"
            + "", compile(text));
    }
