...
class Spin2ObjectCompilerTest {
    ...
    void testSendAssign() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000F 0000F       4D 53 81       REG_WRITE +$1D3\n"
            + "00012 00012       04             RETURN\n"
            + "' PRI out()\n"
            + "00013 00013       00             (stack size)\n"
            + "00014 00014       04             RETURN\n"
    ...
    void testIndexPostEffects() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       02             (stack size)\n"
            + "'     b[3]++\n"
            + "00009 00009       5D 10          VAR_SETUP LONG DBASE+$00001 (short)\n"
            + "0000B 0000B       83             POST_INC\n"
            + "'     b[3]~\n"
            + "0000C 0000C       A1             CONSTANT (0)\n"
            + "0000D 0000D       5D 10 81       VAR_WRITE LONG DBASE+$00001 (short)\n"
            + "'     a := b[3]++\n"
            + "00010 00010       5D 10          VAR_SETUP LONG DBASE+$00001 (short)\n"
            + "00012 00012       87             POST_INC (push)\n"
            + "00013 00013       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := b[3]~\n"
            + "00014 00014       A1             CONSTANT (0)\n"
            + "00015 00015       5D 10          VAR_SETUP LONG DBASE+$00001 (short)\n"
            + "00017 00017       8D             SWAP\n"
            + "00018 00018       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := long[3]++\n"
            + "00019 00019       A4             CONSTANT (3)\n"
    ...
    void testPreEffects() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     ++a[1]\n"
            + "0001F 0001F       5D 04          VAR_SETUP LONG DBASE+$00000 (short)\n"
            + "00021 00021       83             PRE_INC\n"
            + "'     --b[2]\n"
            + "00022 00022       5D 0C          VAR_SETUP LONG DBASE+$00001 (short)\n"
    ...
    void testVariableIndex() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000D 0000D       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := b[1]\n"
            + "0000E 0000E       5D 08 80       VAR_READ LONG DBASE+$00001 (short)\n"
            + "00011 00011       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     b[c] := a\n"
            + "00012 00012       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            ...
            + "'     b[1] := a\n"
            + "00017 00017       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00018 00018       5D 08 81       VAR_WRITE LONG DBASE+$00001 (short)\n"
            + "0001B 0001B       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testBitFieldPostEffects() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000D 0000D       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := b[3].[2..1]--\n"
            + "0000E 0000E       5D 10          VAR_SETUP LONG DBASE+$00001 (short)\n"
            ...
            + "00026 00026       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     b[3].[1]++\n"
            + "00027 00027       5D 10          VAR_SETUP LONG DBASE+$00001 (short)\n"
            + "00029 00029       E1             BITFIELD_SETUP (short)\n"
            + "0002A 0002A       83             POST_INC\n"
            + "'     b[3].[2..1]--\n"
            + "0002B 0002B       5D 10          VAR_SETUP LONG DBASE+$00001 (short)\n"
    ...
    void testPostAssign() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00011 00011       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := b[0]\\c[1]\n"
            + "00012 00012       5D 0C 80       VAR_READ LONG DBASE+$00002 (short)\n"
    ...
    void testMethodPointersArray() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00017 00017       5D 0C 80       VAR_READ LONG DBASE+$00002 (short)\n"
    ...
    void testClkModeAndFreq() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00018 00018       F1             VAR_WRITE LONG DBASE+$00001 (short)\n"
            + "'         a := @CLKMODE\n"
            + "00019 00019       42 40          CONSTANT (64)\n"
            + "0001B 0001B       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'         b := @CLKFREQ\n"
            + "0001C 0001C       42 44          CONSTANT (68)\n"
            + "0001E 0001E       F1             VAR_WRITE LONG DBASE+$00001 (short)\n"
            + "0001F 0001F       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructureAssignments() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     point.x := 1\n"
            + "00009 00009       A2             CONSTANT (1)\n"
            + "0000A 0000A       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0000D 0000D       63 81          MEM_WRITE LONG\n"
            + "'     point.y := 2\n"
            + "0000F 0000F       A3             CONSTANT (2)\n"
            + "00010 00010       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00013 00013       63 81          MEM_WRITE LONG\n"
            + "'     line.a.x := 3\n"
            + "00015 00015       A4             CONSTANT (3)\n"
            + "00016 00016       50 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00019 00019       63 81          MEM_WRITE LONG\n"
            + "'     line.a.y := 4\n"
            + "0001B 0001B       A5             CONSTANT (4)\n"
            + "0001C 0001C       50 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "0001F 0001F       63 81          MEM_WRITE LONG\n"
            + "'     line.b.x := 5\n"
            + "00021 00021       A6             CONSTANT (5)\n"
            + "00022 00022       50 14 7F       MEM_ADDRESS VBASE+$00014\n"
            + "00025 00025       63 81          MEM_WRITE LONG\n"
            + "'     line.b.y := 6\n"
            + "00027 00027       A7             CONSTANT (6)\n"
            + "00028 00028       50 18 7F       MEM_ADDRESS VBASE+$00018\n"
            + "0002B 0002B       63 81          MEM_WRITE LONG\n"
            + "'     line.color := 7\n"
            + "0002D 0002D       A8             CONSTANT (7)\n"
            + "0002E 0002E       50 1C 7F       MEM_ADDRESS VBASE+$0001C\n"
            + "00031 00031       61 81          MEM_WRITE BYTE\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructureRead() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       01             (stack size)\n"
            + "'     a := point.x\n"
            + "00009 00009       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0000C 0000C       63 80          MEM_READ LONG\n"
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := point.y\n"
            + "0000F 0000F       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00012 00012       63 80          MEM_READ LONG\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.x\n"
            + "00015 00015       50 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00018 00018       63 80          MEM_READ LONG\n"
            + "0001A 0001A       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y\n"
            + "0001B 0001B       50 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "0001E 0001E       63 80          MEM_READ LONG\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.b.x\n"
            + "00021 00021       50 14 7F       MEM_ADDRESS VBASE+$00014\n"
            + "00024 00024       63 80          MEM_READ LONG\n"
            + "00026 00026       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.b.y\n"
            + "00027 00027       50 18 7F       MEM_ADDRESS VBASE+$00018\n"
            + "0002A 0002A       63 80          MEM_READ LONG\n"
            + "0002C 0002C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.color\n"
            + "0002D 0002D       50 1C 7F       MEM_ADDRESS VBASE+$0001C\n"
            + "00030 00030       61 80          MEM_READ BYTE\n"
            + "00032 00032       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructureArrayRead() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[0].a.x\n"
            + "0000F 0000F       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00012 00012       63 80          MEM_READ LONG\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y\n"
            + "00015 00015       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00018 00018       63 80          MEM_READ LONG\n"
            + "0001A 0001A       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[0].a.y\n"
            + "0001B 0001B       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "0001E 0001E       63 80          MEM_READ LONG\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[1].a.x\n"
            + "00021 00021       50 15 7F       MEM_ADDRESS VBASE+$00015\n"
            + "00024 00024       63 80          MEM_READ LONG\n"
            + "00026 00026       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[1].a.y\n"
            + "00027 00027       50 19 7F       MEM_ADDRESS VBASE+$00019\n"
            + "0002A 0002A       63 80          MEM_READ LONG\n"
            + "0002C 0002C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[b].a.x\n"
            + "0002D 0002D       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "0002E 0002E       42 11          CONSTANT (17)\n"
            + "00030 00030       96             MULTIPLY\n"
            + "00031 00031       53 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00034 00034       63 80          MEM_READ LONG\n"
            + "00036 00036       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[b + 1].a.y\n"
            + "00037 00037       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00038 00038       A2             CONSTANT (1)\n"
            + "00039 00039       8A             ADD\n"
            + "0003A 0003A       42 11          CONSTANT (17)\n"
            + "0003C 0003C       96             MULTIPLY\n"
            + "0003D 0003D       A5             CONSTANT (4)\n"
            + "0003E 0003E       8A             ADD\n"
            + "0003F 0003F       53 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00042 00042       63 80          MEM_READ LONG\n"
    ...
    void testStructureArrayAssignment() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     line[0].a.x := a\n"
            + "0000F 0000F       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00010 00010       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00013 00013       63 81          MEM_WRITE LONG\n"
            + "'     line.a.y := a\n"
            + "00015 00015       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00016 00016       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00019 00019       63 81          MEM_WRITE LONG\n"
            + "'     line[0].a.y := a\n"
            + "0001B 0001B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0001C 0001C       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "0001F 0001F       63 81          MEM_WRITE LONG\n"
            + "'     line[1].a.x := a\n"
            + "00021 00021       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00022 00022       50 15 7F       MEM_ADDRESS VBASE+$00015\n"
            + "00025 00025       63 81          MEM_WRITE LONG\n"
            + "'     line[1].a.y := a\n"
            + "00027 00027       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00028 00028       50 19 7F       MEM_ADDRESS VBASE+$00019\n"
            + "0002B 0002B       63 81          MEM_WRITE LONG\n"
            + "'     line[b].a.x := a\n"
            + "0002D 0002D       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0002E 0002E       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "0002F 0002F       42 11          CONSTANT (17)\n"
            + "00031 00031       96             MULTIPLY\n"
            + "00032 00032       53 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00035 00035       63 81          MEM_WRITE LONG\n"
            + "'     line[b].a.y := a\n"
            + "00037 00037       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00038 00038       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00039 00039       42 11          CONSTANT (17)\n"
            + "0003B 0003B       96             MULTIPLY\n"
            + "0003C 0003C       A5             CONSTANT (4)\n"
            + "0003D 0003D       8A             ADD\n"
            + "0003E 0003E       53 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00041 00041       63 81          MEM_WRITE LONG\n"
    ...
    void testStructureAddress() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       01             (stack size)\n"
            + "'     a := @line\n"
            + "00009 00009       50 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "0000C 0000C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line.a\n"
            + "0000D 0000D       50 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00010 00010       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line.b\n"
            + "00011 00011       50 14 7F       MEM_ADDRESS VBASE+$00014\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line[1]\n"
            + "00015 00015       50 1D 7F       MEM_ADDRESS VBASE+$0001D\n"
            + "00018 00018       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line[1].a\n"
            + "00019 00019       50 1D 7F       MEM_ADDRESS VBASE+$0001D\n"
            + "0001C 0001C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line[1].b\n"
            + "0001D 0001D       50 25 7F       MEM_ADDRESS VBASE+$00025\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00021 00021       04             RETURN\n"
            + "00022 00022       00 00          Padding\n"
            + "", compile(text));
    ...
    void testLocalStructureAssignments() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     point.x := 1\n"
            + "00009 00009       A2             CONSTANT (1)\n"
            + "0000A 0000A       51 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "0000D 0000D       63 81          MEM_WRITE LONG\n"
            + "'     point.y := 2\n"
            + "0000F 0000F       A3             CONSTANT (2)\n"
            + "00010 00010       51 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "00013 00013       63 81          MEM_WRITE LONG\n"
            + "'     line.a.x := 3\n"
            + "00015 00015       A4             CONSTANT (3)\n"
            + "00016 00016       51 08 7F       MEM_ADDRESS DBASE+$00008\n"
            + "00019 00019       63 81          MEM_WRITE LONG\n"
            + "'     line.a.y := 4\n"
            + "0001B 0001B       A5             CONSTANT (4)\n"
            + "0001C 0001C       51 0C 7F       MEM_ADDRESS DBASE+$0000C\n"
            + "0001F 0001F       63 81          MEM_WRITE LONG\n"
            + "'     line.b.x := 5\n"
            + "00021 00021       A6             CONSTANT (5)\n"
            + "00022 00022       51 10 7F       MEM_ADDRESS DBASE+$00010\n"
            + "00025 00025       63 81          MEM_WRITE LONG\n"
            + "'     line.b.y := 6\n"
            + "00027 00027       A7             CONSTANT (6)\n"
            + "00028 00028       51 14 7F       MEM_ADDRESS DBASE+$00014\n"
            + "0002B 0002B       63 81          MEM_WRITE LONG\n"
            + "'     line.color := 7\n"
            + "0002D 0002D       A8             CONSTANT (7)\n"
            + "0002E 0002E       51 18 7F       MEM_ADDRESS DBASE+$00018\n"
            + "00031 00031       61 81          MEM_WRITE BYTE\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructurePostEffects() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     a := line.a.x++\n"
            + "00009 00009       50 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "0000C 0000C       63             MEM_SETUP LONG\n"
            + "0000D 0000D       87             POST_INC (push)\n"
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y--\n"
            + "0000F 0000F       50 10 7F       MEM_ADDRESS VBASE+$00010\n"
            ...
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     ++line.a.x\n"
            + "00021 00021       50 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00024 00024       63             MEM_SETUP LONG\n"
            + "00025 00025       83             PRE_INC\n"
            + "'     --line.a.y\n"
            + "00026 00026       50 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "00029 00029       63             MEM_SETUP LONG\n"
    ...
    void testStructureChainedAssignment() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     pt.x := pt.y := 1\n"
            + "00009 00009       A2             CONSTANT (1)\n"
            + "0000A 0000A       51 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "0000D 0000D       63             MEM_SETUP LONG\n"
            + "0000E 0000E       82             WRITE\n"
            + "0000F 0000F       51 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "00012 00012       63 81          MEM_WRITE LONG\n"
            + "'     pt.x := pt.y := a\n"
            + "00014 00014       E2             VAR_READ LONG DBASE+$00002 (short)\n"
            + "00015 00015       51 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "00018 00018       63             MEM_SETUP LONG\n"
            + "00019 00019       82             WRITE\n"
            + "0001A 0001A       51 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "0001D 0001D       63 81          MEM_WRITE LONG\n"
            + "'     pt.x.[5..0] := pt.y := 1\n"
            + "0001F 0001F       A2             CONSTANT (1)\n"
            + "00020 00020       51 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "00023 00023       63             MEM_SETUP LONG\n"
            + "00024 00024       82             WRITE\n"
            + "00025 00025       51 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "00028 00028       63             MEM_SETUP LONG\n"
    ...
    void testStructureBitField() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00011 00011       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := point.y.[b..0]\n"
            + "00012 00012       50 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00015 00015       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00016 00016       A1             CONSTANT (0)\n"
            + "00017 00017       9F 94          BITRANGE\n"
            + "00019 00019       63             MEM_SETUP LONG\n"
            + "0001A 0001A       DE 80          BITFIELD_READ (pop)\n"
            + "0001C 0001C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := point.x.[5..0]++\n"
            + "0001D 0001D       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00020 00020       63             MEM_SETUP LONG\n"
            + "00021 00021       DF A0 01       BITFIELD_SETUP\n"
            + "00024 00024       87             POST_INC (push)\n"
            + "00025 00025       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     point.x.[5..0] := a\n"
            + "00026 00026       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00027 00027       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0002A 0002A       63             MEM_SETUP LONG\n"
            + "0002B 0002B       DF A0 01 81    BITFIELD_WRITE\n"
            + "'     point.x.[b..0] := a\n"
            + "0002F 0002F       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00030 00030       50 04 7F       MEM_ADDRESS VBASE+$00004\n"
