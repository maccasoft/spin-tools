...
class Spin2ObjectCompilerTest {
    ...
    void testStructureAssignments() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "'     point.x := 1\n"
            + "00009 00009       A2             CONSTANT (1)\n"
            + "0000A 0000A       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0000D 0000D       68 81          MEM_WRITE LONG\n"
            + "'     point.y := 2\n"
            + "0000F 0000F       A3             CONSTANT (2)\n"
            + "00010 00010       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00013 00013       68 81          MEM_WRITE LONG\n"
            + "'     line.a.x := 3\n"
            + "00015 00015       A4             CONSTANT (3)\n"
            + "00016 00016       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00019 00019       68 81          MEM_WRITE LONG\n"
            + "'     line.a.y := 4\n"
            + "0001B 0001B       A5             CONSTANT (4)\n"
            + "0001C 0001C       52 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "0001F 0001F       68 81          MEM_WRITE LONG\n"
            + "'     line.b.x := 5\n"
            + "00021 00021       A6             CONSTANT (5)\n"
            + "00022 00022       52 14 7F       MEM_ADDRESS VBASE+$00014\n"
            + "00025 00025       68 81          MEM_WRITE LONG\n"
            + "'     line.b.y := 6\n"
            + "00027 00027       A7             CONSTANT (6)\n"
            + "00028 00028       52 18 7F       MEM_ADDRESS VBASE+$00018\n"
            + "0002B 0002B       68 81          MEM_WRITE LONG\n"
            + "'     line.color := 7\n"
            + "0002D 0002D       A8             CONSTANT (7)\n"
            + "0002E 0002E       52 1C 7F       MEM_ADDRESS VBASE+$0001C\n"
            + "00031 00031       66 81          MEM_WRITE BYTE\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructureRead() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       01             (stack size)\n"
            + "'     a := point.x\n"
            + "00009 00009       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0000C 0000C       68 80          MEM_READ LONG\n"
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := point.y\n"
            + "0000F 0000F       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00012 00012       68 80          MEM_READ LONG\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.x\n"
            + "00015 00015       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00018 00018       68 80          MEM_READ LONG\n"
            + "0001A 0001A       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y\n"
            + "0001B 0001B       52 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "0001E 0001E       68 80          MEM_READ LONG\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.b.x\n"
            + "00021 00021       52 14 7F       MEM_ADDRESS VBASE+$00014\n"
            + "00024 00024       68 80          MEM_READ LONG\n"
            + "00026 00026       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.b.y\n"
            + "00027 00027       52 18 7F       MEM_ADDRESS VBASE+$00018\n"
            + "0002A 0002A       68 80          MEM_READ LONG\n"
            + "0002C 0002C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.color\n"
            + "0002D 0002D       52 1C 7F       MEM_ADDRESS VBASE+$0001C\n"
            + "00030 00030       66 80          MEM_READ BYTE\n"
            + "00032 00032       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    @Test
    void testStructureArrayRead() throws Exception {
        String text = ""
            + "CON\n"
            + "    sPoint(x, y)\n"
            + "    sLine(sPoint a, sPoint b, BYTE color)\n"
        ...
        Assertions.assertEquals(""
            + "' Object header (var size 40)\n"
            + "00000 00000       08 00 00 80    Method start @ $00008 (0 parameters, 0 returns)\n"
            + "00004 00004       46 00 00 00    End\n"
            + "' PUB start() | a, b\n"
            + "00008 00008       02             (stack size)\n"
            + "'     a := line.a.x\n"
            + "00009 00009       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            ...
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[0].a.x\n"
            + "0000F 0000F       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00012 00012       68 80          MEM_READ LONG\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y\n"
            + "00015 00015       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00018 00018       68 80          MEM_READ LONG\n"
            + "0001A 0001A       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[0].a.y\n"
            + "0001B 0001B       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "0001E 0001E       68 80          MEM_READ LONG\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[1].a.x\n"
            + "00021 00021       52 15 7F       MEM_ADDRESS VBASE+$00015\n"
            + "00024 00024       68 80          MEM_READ LONG\n"
            + "00026 00026       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[1].a.y\n"
            + "00027 00027       52 19 7F       MEM_ADDRESS VBASE+$00019\n"
            + "0002A 0002A       68 80          MEM_READ LONG\n"
            + "0002C 0002C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[b].a.x\n"
            + "0002D 0002D       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "0002E 0002E       44 11          CONSTANT (17)\n"
            + "00030 00030       96             MULTIPLY\n"
            + "00031 00031       55 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00034 00034       68 80          MEM_READ LONG\n"
            + "00036 00036       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line[b + 1].a.y\n"
            + "00037 00037       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00038 00038       A2             CONSTANT (1)\n"
            + "00039 00039       8A             ADD\n"
            + "0003A 0003A       44 11          CONSTANT (17)\n"
            + "0003C 0003C       96             MULTIPLY\n"
            + "0003D 0003D       A5             CONSTANT (4)\n"
            + "0003E 0003E       8A             ADD\n"
            + "0003F 0003F       55 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00042 00042       68 80          MEM_READ LONG\n"
            + "00044 00044       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00045 00045       04             RETURN\n"
            + "00046 00046       00 00          Padding\n"
            + "", compile(text));
    }

    @Test
    void testStructureArrayAssignment() throws Exception {
        String text = ""
            + "CON\n"
            + "    sPoint(x, y)\n"
            + "    sLine(sPoint a, sPoint b, BYTE color)\n"
        ...
        Assertions.assertEquals(""
            ...
            + "'     line[0].a.x := a\n"
            + "0000F 0000F       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00010 00010       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00013 00013       68 81          MEM_WRITE LONG\n"
            + "'     line.a.y := a\n"
            + "00015 00015       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00016 00016       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00019 00019       68 81          MEM_WRITE LONG\n"
            + "'     line[0].a.y := a\n"
            + "0001B 0001B       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0001C 0001C       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "0001F 0001F       68 81          MEM_WRITE LONG\n"
            + "'     line[1].a.x := a\n"
            + "00021 00021       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00022 00022       52 15 7F       MEM_ADDRESS VBASE+$00015\n"
            + "00025 00025       68 81          MEM_WRITE LONG\n"
            + "'     line[1].a.y := a\n"
            + "00027 00027       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00028 00028       52 19 7F       MEM_ADDRESS VBASE+$00019\n"
            + "0002B 0002B       68 81          MEM_WRITE LONG\n"
            + "'     line[b].a.x := a\n"
            + "0002D 0002D       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "0002E 0002E       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "0002F 0002F       44 11          CONSTANT (17)\n"
            + "00031 00031       96             MULTIPLY\n"
            + "00032 00032       55 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00035 00035       68 81          MEM_WRITE LONG\n"
            + "'     line[b].a.y := a\n"
            + "00037 00037       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00038 00038       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00039 00039       44 11          CONSTANT (17)\n"
            + "0003B 0003B       96             MULTIPLY\n"
            + "0003C 0003C       A5             CONSTANT (4)\n"
            + "0003D 0003D       8A             ADD\n"
            + "0003E 0003E       55 04 7F       MEM_ADDRESS INDEXED VBASE+$00004\n"
            + "00041 00041       68 81          MEM_WRITE LONG\n"
            + "00043 00043       04             RETURN\n"
            + "", compile(text));
    }
    ...
    void testStructureAddress() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00008 00008       01             (stack size)\n"
            + "'     a := @line\n"
            + "00009 00009       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "0000C 0000C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line.a\n"
            + "0000D 0000D       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00010 00010       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line.b\n"
            + "00011 00011       52 14 7F       MEM_ADDRESS VBASE+$00014\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line[1]\n"
            + "00015 00015       52 1D 7F       MEM_ADDRESS VBASE+$0001D\n"
            + "00018 00018       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line[1].a\n"
            + "00019 00019       52 1D 7F       MEM_ADDRESS VBASE+$0001D\n"
            + "0001C 0001C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := @line[1].b\n"
            + "0001D 0001D       52 25 7F       MEM_ADDRESS VBASE+$00025\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "00021 00021       04             RETURN\n"
            + "00022 00022       00 00          Padding\n"
            + "", compile(text));
    ...
    @Test
    void testLocalStructureAssignments() throws Exception {
        String text = ""
            + "CON\n"
            + "    sPoint(x, y)\n"
            + "    sLine(sPoint a, sPoint b, BYTE color)\n"
            + "\n"
            + "PUB start() | sPoint point, sLine line, a\n"
            + "\n"
            + "    point.x := 1\n"
            + "    point.y := 2\n"
            + "    line.a.x := 3\n"
        ...
        Assertions.assertEquals(""
            ...
            + "'     point.x := 1\n"
            + "00009 00009       A2             CONSTANT (1)\n"
            + "0000A 0000A       53 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "0000D 0000D       68 81          MEM_WRITE LONG\n"
            + "'     point.y := 2\n"
            + "0000F 0000F       A3             CONSTANT (2)\n"
            + "00010 00010       53 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "00013 00013       68 81          MEM_WRITE LONG\n"
            + "'     line.a.x := 3\n"
            + "00015 00015       A4             CONSTANT (3)\n"
            + "00016 00016       53 08 7F       MEM_ADDRESS DBASE+$00008\n"
            + "00019 00019       68 81          MEM_WRITE LONG\n"
            + "'     line.a.y := 4\n"
            + "0001B 0001B       A5             CONSTANT (4)\n"
            + "0001C 0001C       53 0C 7F       MEM_ADDRESS DBASE+$0000C\n"
            + "0001F 0001F       68 81          MEM_WRITE LONG\n"
            + "'     line.b.x := 5\n"
            + "00021 00021       A6             CONSTANT (5)\n"
            + "00022 00022       53 10 7F       MEM_ADDRESS DBASE+$00010\n"
            + "00025 00025       68 81          MEM_WRITE LONG\n"
            + "'     line.b.y := 6\n"
            + "00027 00027       A7             CONSTANT (6)\n"
            + "00028 00028       53 14 7F       MEM_ADDRESS DBASE+$00014\n"
            + "0002B 0002B       68 81          MEM_WRITE LONG\n"
            + "'     line.color := 7\n"
            + "0002D 0002D       A8             CONSTANT (7)\n"
            + "0002E 0002E       53 18 7F       MEM_ADDRESS DBASE+$00018\n"
            + "00031 00031       66 81          MEM_WRITE BYTE\n"
            + "00033 00033       04             RETURN\n"
            + "", compile(text));
    }
    ...
    @Test
    void testStructurePostEffects() throws Exception {
        String text = ""
            + "CON\n"
            + "    sPoint(x, y)\n"
            + "    sLine(sPoint a, sPoint b, BYTE color)\n"
        ...
        Assertions.assertEquals(""
            ...
            + "'     a := line.a.x++\n"
            + "00009 00009       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "0000C 0000C       68             MEM_SETUP LONG\n"
            + "0000D 0000D       87             POST_INC (push)\n"
            + "0000E 0000E       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := line.a.y--\n"
            + "0000F 0000F       52 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "00012 00012       68             MEM_SETUP LONG\n"
            + "00013 00013       88             POST_DEC (push)\n"
            + "00014 00014       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := ++line.a.x\n"
            + "00015 00015       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00018 00018       68             MEM_SETUP LONG\n"
            ...
            + "0001B 0001B       52 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "0001E 0001E       68             MEM_SETUP LONG\n"
            + "0001F 0001F       86             PRE_DEC (push)\n"
            + "00020 00020       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     ++line.a.x\n"
            + "00021 00021       52 0C 7F       MEM_ADDRESS VBASE+$0000C\n"
            + "00024 00024       68             MEM_SETUP LONG\n"
            + "00025 00025       83             PRE_INC\n"
            + "'     --line.a.y\n"
            + "00026 00026       52 10 7F       MEM_ADDRESS VBASE+$00010\n"
            + "00029 00029       68             MEM_SETUP LONG\n"
            + "0002A 0002A       84             PRE_DEC\n"
            + "0002B 0002B       04             RETURN\n"
            + "", compile(text));
    }

    @Test
    void testStructureChainedAssignment() throws Exception {
        String text = ""
            + "CON\n"
            + "    sPoint(x, y)\n"
            + "\n"
            + "PUB start() | sPoint pt, a\n"
            + "\n"
            + "    pt.x := pt.y := 1\n"
            + "    pt.x := pt.y := a\n"
            + "\n"
        ...
        Assertions.assertEquals(""
            ...
            + "'     pt.x := pt.y := 1\n"
            + "00009 00009       A2             CONSTANT (1)\n"
            + "0000A 0000A       53 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "0000D 0000D       68             MEM_SETUP LONG\n"
            + "0000E 0000E       82             WRITE\n"
            + "0000F 0000F       53 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "00012 00012       68 81          MEM_WRITE LONG\n"
            + "'     pt.x := pt.y := a\n"
            + "00014 00014       E2             VAR_READ LONG DBASE+$00002 (short)\n"
            + "00015 00015       53 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "00018 00018       68             MEM_SETUP LONG\n"
            + "00019 00019       82             WRITE\n"
            + "0001A 0001A       53 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "0001D 0001D       68 81          MEM_WRITE LONG\n"
            + "'     pt.x.[5..0] := pt.y := 1\n"
            + "0001F 0001F       A2             CONSTANT (1)\n"
            + "00020 00020       53 04 7F       MEM_ADDRESS DBASE+$00004\n"
            + "00023 00023       68             MEM_SETUP LONG\n"
            + "00024 00024       82             WRITE\n"
            + "00025 00025       53 00 7F       MEM_ADDRESS DBASE+$00000\n"
            + "00028 00028       68             MEM_SETUP LONG\n"
            + "00029 00029       DF A0 01 81    BITFIELD_WRITE\n"
            + "0002D 0002D       04             RETURN\n"
            + "0002E 0002E       00 00          Padding\n"
            + "", compile(text));
    }
    ...
    void testStructureBitField() throws Exception {
        ...
        Assertions.assertEquals(""
            + "' Object header (var size 12)\n"
            + "00000 00000       08 00 00 80    Method start @ $00008 (0 parameters, 0 returns)\n"
            + "00004 00004       3B 00 00 00    End\n"
            + "' PUB start() | a, b\n"
            + "00008 00008       02             (stack size)\n"
            + "'     a := point.x.[5..0]\n"
            + "00009 00009       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0000C 0000C       68             MEM_SETUP LONG\n"
            + "0000D 0000D       DF A0 01 80    BITFIELD_READ\n"
            + "00011 00011       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := point.y.[b..0]\n"
            + "00012 00012       52 08 7F       MEM_ADDRESS VBASE+$00008\n"
            + "00015 00015       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00016 00016       A1             CONSTANT (0)\n"
            + "00017 00017       9F 94          BITRANGE\n"
            + "00019 00019       68             MEM_SETUP LONG\n"
            + "0001A 0001A       DE 80          BITFIELD_READ (pop)\n"
            + "0001C 0001C       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     a := point.x.[5..0]++\n"
            + "0001D 0001D       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00020 00020       68             MEM_SETUP LONG\n"
            + "00021 00021       DF A0 01       BITFIELD_SETUP\n"
            + "00024 00024       87             POST_INC (push)\n"
            + "00025 00025       F0             VAR_WRITE LONG DBASE+$00000 (short)\n"
            + "'     point.x.[5..0] := a\n"
            + "00026 00026       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00027 00027       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "0002A 0002A       68             MEM_SETUP LONG\n"
            + "0002B 0002B       DF A0 01 81    BITFIELD_WRITE\n"
            + "'     point.x.[b..0] := a\n"
            + "0002F 0002F       E0             VAR_READ LONG DBASE+$00000 (short)\n"
            + "00030 00030       52 04 7F       MEM_ADDRESS VBASE+$00004\n"
            + "00033 00033       E1             VAR_READ LONG DBASE+$00001 (short)\n"
            + "00034 00034       A1             CONSTANT (0)\n"
            + "00035 00035       9F 94          BITRANGE\n"
            + "00037 00037       68             MEM_SETUP LONG\n"
            + "00038 00038       DE 81          BITFIELD_WRITE (pop)\n"
            + "0003A 0003A       04             RETURN\n"
            + "0003B 0003B       00             Padding\n"
            + "", compile(text));
    }
    ...
    void testExpandedPAsmLinesLabel() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00024 00024       00             (stack size)\n"
            + "'     coginit(cogexec_new, @entry, 0)\n"
            + "00025 00025       44 10          CONSTANT (16)\n"
            + "00027 00027       5D 08 7F       MEM_ADDRESS PBASE+$00008\n"
