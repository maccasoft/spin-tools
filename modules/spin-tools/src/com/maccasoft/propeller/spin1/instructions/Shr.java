...
public class Shr extends Spin1PAsmInstructionFactory {
     ...
     * SHR     D,{#}S   {WC/WZ/NR/WR}
     */
    public class Shr_ extends Spin1InstructionObject {
        ...
        public Shr_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 001010_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b001010);
