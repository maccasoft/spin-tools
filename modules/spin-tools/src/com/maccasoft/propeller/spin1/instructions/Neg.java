...
public class Neg extends Spin1PAsmInstructionFactory {
     ...
     * NEG     D,{#}S   {WC/WZ/NR/WR}
     */
    public class Neg_ extends Spin1InstructionObject {
        ...
        public Neg_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 101001_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b101001);
