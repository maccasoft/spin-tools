...
public class Rdbyte extends Spin1PAsmInstructionFactory {
    ...
    /*
     * RDBYTE  D,{#}S   {WC/WZ/NR/WR}
     */
    public class Rdbyte_ extends Spin1InstructionObject {
        ...
        public Rdbyte_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 000000_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b000000);
