...
public class Adds extends Spin1PAsmInstructionFactory {
    ...
    /*
     * ADDS    D,{#}S   {WC/WZ/NR/WR}
     */
    public class Adds_ extends Spin1InstructionObject {
        ...
        // 110100_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b110100);
