...
public class Subs extends Spin1PAsmInstructionFactory {
    ...
    public class Subs_ extends Spin1InstructionObject {
        ...
        public Subs_(Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b110101);
