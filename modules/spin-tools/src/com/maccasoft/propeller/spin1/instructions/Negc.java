...
public class Negc extends Spin1PAsmInstructionFactory {
    ...
    /*
     * NEGC    D,{#}S   {WC/WZ/NR/WR}
     */
    public class Negc_ extends Spin1InstructionObject {
        ...
        public Negc_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 101100_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b101100);
