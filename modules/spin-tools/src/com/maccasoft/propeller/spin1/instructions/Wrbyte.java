...
public class Wrbyte extends Spin1PAsmInstructionFactory {
    ...
    public Spin1InstructionObject createObject(Spin1Context context, String condition, List<Spin1PAsmExpression> arguments, String effect) {
        if (Spin1PAsmSchema.D_S.check(arguments, effect)) {
            return new Wrbyte_(context, condition, arguments.get(0), arguments.get(1), effect);
        }
        throw new RuntimeException("Invalid arguments");
    }

    /*
     * WRBYTE  D,{#}S   {WC/WZ/NR/WR}
     */
    public class Wrbyte_ extends Spin1InstructionObject {
        ...
        public Wrbyte_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 000000_000i_1111_ddddddddd_sssssssss
