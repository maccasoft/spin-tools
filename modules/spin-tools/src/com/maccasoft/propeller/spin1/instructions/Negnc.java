...
public class Negnc extends Spin1PAsmInstructionFactory {
    ...
    /*
     * NEGNC   D,{#}S   {WC/WZ/NR/WR}
     */
    public class Negnc_ extends Spin1InstructionObject {
        ...
        public Negnc_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 101101_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b101101);
