...
public class Tjz extends Spin1PAsmInstructionFactory {
    ...
    public Spin1InstructionObject createObject(Spin1Context context, String condition, List<Spin1PAsmExpression> arguments, String effect) {
        if (Spin1PAsmSchema.D_S.check(arguments, effect)) {
            return new Tjz_(context, condition, arguments.get(0), arguments.get(1), effect);
        }
     ...
     * TJZ     D,{#}S   {WC/WZ/NR/WR}
     */
    public class Tjz_ extends Spin1InstructionObject {
        ...
        public Tjz_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 111011_000i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, null), 0b111011);
