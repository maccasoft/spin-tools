...
public class Cmpx extends Spin1PAsmInstructionFactory {
    ...
    public Spin1InstructionObject createObject(Spin1PAsmLine line) {
        if (Spin1PAsmSchema.D_S_WC_WZ.check(line.getArguments(), line.getEffect())) {
            ...
            return new Cmpx_(line.getScope(), line.getCondition(), line.getArguments().get(0), line.getArguments().get(1), line.getEffect());
        }
    ...
    public class Cmpx_ extends Spin1InstructionObject {
        ...
        public Cmpx_(Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, null), 0b110011);
