...
public class Mov extends Spin1PAsmInstructionFactory {
     ...
     * MOV     D,{#}S   {WC/WZ/NR/WR}
     */
    public class Mov_ extends Spin1InstructionObject {
        ...
        public Mov_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 101000_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b101000);
