...
public class Spin2ObjectCompiler {
    ...
    class BytecodeCompiler extends Spin2BytecodeCompiler {

        public BytecodeCompiler(Map<String, ObjectInfo> objects, List<Object> debugStatements) {
            super(objects, debugStatements);
        }
    ...
    public void compile(Node root) {
        ...
        Spin2BytecodeCompiler compiler = new BytecodeCompiler(objects, debugStatements);
