 ...
 * JMPREL  {#}D
 */
public class Jmprel extends Spin2PAsmInstructionFactory {
    ...
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        ...
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Jmprel_(context, condition, arguments.get(0));
        }
        throw new RuntimeException("Invalid arguments");
    }

    public static class Jmprel_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Jmprel_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b000110000);
