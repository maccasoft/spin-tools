...
public class Jmp extends Spin2PAsmInstructionFactory {
    ...
    public class Jmp_ extends Spin2InstructionObject {
        ...
        public Jmp_(Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
    ...
    public class Jmp_D_ extends Spin2InstructionObject {
        ...
        public Jmp_D_(Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
