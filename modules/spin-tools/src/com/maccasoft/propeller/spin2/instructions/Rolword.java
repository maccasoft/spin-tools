...
public class Rolword extends Spin2PAsmInstructionFactory {
    ...
    public class Rolword_ extends Spin2InstructionObject {
        ...
        public Rolword_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, Spin2PAsmExpression n) {
            super(context);
    ...
    public class Rolword_D_ extends Spin2InstructionObject {
        ...
        public Rolword_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
