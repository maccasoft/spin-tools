...
public class Neg extends Spin2PAsmInstructionFactory {
    ...
    public class Neg_ extends Spin2InstructionObject {
        ...
        public Neg_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
    ...
    public class Neg_D_ extends Spin2InstructionObject {
        ...
        public Neg_D_(Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
