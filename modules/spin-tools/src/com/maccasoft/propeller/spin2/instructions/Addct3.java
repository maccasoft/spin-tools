...
public class Addct3 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.D_S.check(arguments, effect)) {
            return new Addct3_(context, condition, arguments.get(0), arguments.get(1));
        }
    ...
    public class Addct3_ extends Spin2InstructionObject {
        ...
        public Addct3_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
