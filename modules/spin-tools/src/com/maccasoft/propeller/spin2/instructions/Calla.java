...
public class Calla extends Spin2PAsmInstructionFactory {
    ...
    public class Calla_ extends Spin2InstructionObject {
        ...
        public Calla_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
    ...
    public class Calla_D_ extends Spin2InstructionObject {
        ...
        public Calla_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
