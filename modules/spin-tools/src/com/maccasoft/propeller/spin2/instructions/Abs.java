...
public class Abs extends Spin2PAsmInstructionFactory {
    ...
    public class Abs_ extends Spin2InstructionObject {
        ...
        public Abs_(Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
    ...
    public class Abs_D_ extends Spin2InstructionObject {
        ...
        public Abs_D_(Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
