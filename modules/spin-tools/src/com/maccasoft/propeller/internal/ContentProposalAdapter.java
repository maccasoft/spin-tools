            ...
            public void handleEvent(Event e) {
                ...
                switch (key) {
                    ...
                    case SWT.CR:
                        ...
                        if (p != null) {
                            int currentAcceptance = getProposalAcceptanceStyle();
                            if ((e.stateMask & SWT.MOD1) != 0) {
                                if (currentAcceptance == PROPOSAL_INSERT) {
                                    setProposalAcceptanceStyle(PROPOSAL_REPLACE);
                                }
                                else if (currentAcceptance == PROPOSAL_REPLACE) {
                                    setProposalAcceptanceStyle(PROPOSAL_INSERT);
                                }
                            }
                            acceptCurrentProposal();
                            setProposalAcceptanceStyle(currentAcceptance);
                        }
                        else {
                            close();
                        }
