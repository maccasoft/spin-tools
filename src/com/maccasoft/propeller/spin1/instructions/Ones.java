...
public class Ones extends Spin1PAsmInstructionFactory {
    ...
    /*
     * ONES    D,{#}S   {WC/WZ/NR/WR}
     */
    public class Ones_ extends Spin1InstructionObject {
        ...
        public Ones_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 000111_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b000111);
