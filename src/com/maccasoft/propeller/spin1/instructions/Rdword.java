...
public class Rdword extends Spin1PAsmInstructionFactory {
    ...
    /*
     * RDWORD  D,{#}S   {WC/WZ/NR/WR}
     */
    public class Rdword_ extends Spin1InstructionObject {
        ...
        public Rdword_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 000001_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b000001);
