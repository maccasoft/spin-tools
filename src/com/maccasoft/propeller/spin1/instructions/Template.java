...
public class Template extends Spin1PAsmInstructionFactory {
    ...
    public Spin1InstructionObject createObject(Spin1Context context, String condition, List<Spin1PAsmExpression> arguments, String effect) {
        if (Spin1PAsmSchema.D_S.check(arguments, effect)) {
            return new Template_(context, condition, arguments.get(0), arguments.get(1), effect);
        }
     ...
     */
    public class Template_ extends Spin1InstructionObject {
        ...
        public Template_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // iiiiii_001i_1111_ddddddddd_sssssssss
