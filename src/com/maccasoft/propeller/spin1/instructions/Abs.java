...
public class Abs extends Spin1PAsmInstructionFactory {
     ...
     * ABS     D,{#}S   {WC/WZ/NR/WR}
     */
    public class Abs_ extends Spin1InstructionObject {
        ...
        public Abs_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 101010_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b101010);
