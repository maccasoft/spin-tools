...
public class Cmpsub extends Spin1PAsmInstructionFactory {
    ...
    /*
     * CMPSUB  D,{#}S   {WC/WZ/NR/WR}
     */
    public class Cmpsub_ extends Spin1InstructionObject {
        ...
        public Cmpsub_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 111000_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b111000);
