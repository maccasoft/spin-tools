...
public class Test extends Spin1PAsmInstructionFactory {
    ...
    /*
     * TEST    D,{#}S   {WC/WZ/NR/WR}
     */
    public class Test_ extends Spin1InstructionObject {
        ...
        public Test_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 011000_000i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, null), 0b011000);
