...
public class Muls extends Spin1PAsmInstructionFactory {
    ...
    /*
     * MULS    D,{#}S   {WC/WZ/NR/WR}
     */
    public class Muls_ extends Spin1InstructionObject {
        ...
        public Muls_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 000101_001i_1111_ddddddddd_sssssssss

        @Override
        public byte[] getBytes() {
            int value = instr.setValue(encodeInstructionParameters(condition, dst, src, effect), 0b000101);
