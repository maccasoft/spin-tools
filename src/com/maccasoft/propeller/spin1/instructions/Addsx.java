...
public class Addsx extends Spin1PAsmInstructionFactory {
    ...
    /*
     * ADDSX   D,{#}S   {WC/WZ/NR/WR}
     */
    public class Addsx_ extends Spin1InstructionObject {
        ...
        public Addsx_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        // 110110_001i_1111_ddddddddd_sssssssss
