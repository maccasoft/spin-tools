...
public class Waitvid extends Spin1PAsmInstructionFactory {
    ...
    public class Waitvid_ extends Spin1InstructionObject {
        ...
        public Waitvid_(Spin1Context context, String condition, Spin1PAsmExpression dst, Spin1PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            int value = instr.setValue(0, 0b111111);
