...
public class Altr extends Spin2PAsmInstructionFactory {
    ...
    public class Altr_ extends Spin2InstructionObject {
        ...
        public Altr_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altr_D_ extends Spin2InstructionObject {
        ...
        public Altr_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
