...
public class Fblock extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_S.check(arguments, effect)) {
            return new Fblock_(context, condition, arguments.get(0), arguments.get(1));
        }
     ...
     * FBLOCK  {#}D,{#}S
     */
    public class Fblock_ extends Spin2InstructionObject {
        ...
        public Fblock_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
