...
public class Reti3 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.NONE.check(arguments, effect)) {
            return new Reti3_(context, condition);
        }
     ...
     * RETI3
     */
    public class Reti3_ extends Spin2InstructionObject {

        String condition;

        public Reti3_(Spin2Context context, String condition) {
            super(context);
