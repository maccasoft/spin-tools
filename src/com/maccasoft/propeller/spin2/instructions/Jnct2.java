...
public class Jnct2 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jnct2_(context, condition, arguments.get(0));
        }
     ...
     * JNCT2   {#}S
     */
    public class Jnct2_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jnct2_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000010010);
