...
public class Negnc extends Spin2PAsmInstructionFactory {
    ...
    public class Negnc_ extends Spin2InstructionObject {
        ...
        public Negnc_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = o.setValue(value, 0b0110101);
    ...
    public class Negnc_D_ extends Spin2InstructionObject {
        ...
        public Negnc_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
