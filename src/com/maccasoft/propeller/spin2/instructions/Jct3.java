...
public class Jct3 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jct3_(context, condition, arguments.get(0));
        }
     ...
     * JCT3    {#}S
     */
    public class Jct3_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jct3_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000000011);
