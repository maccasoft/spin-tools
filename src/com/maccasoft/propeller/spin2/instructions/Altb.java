...
public class Altb extends Spin2PAsmInstructionFactory {
    ...
    public class Altb_ extends Spin2InstructionObject {
        ...
        public Altb_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altb_D_ extends Spin2InstructionObject {
        ...
        public Altb_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
