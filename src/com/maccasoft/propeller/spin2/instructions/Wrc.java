...
public class Wrc extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.D.check(arguments, effect)) {
            return new Wrc_(context, condition, arguments.get(0));
        }
     ...
     * WRC     D
     */
    public class Wrc_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Wrc_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
