...
public class Jxmt extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jxmt_(context, condition, arguments.get(0));
        }
     ...
     * JXMT    {#}S
     */
    public class Jxmt_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jxmt_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000001010);
