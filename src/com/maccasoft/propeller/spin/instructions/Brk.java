...
public class Brk extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Brk_(context, condition, arguments.get(0));
        }
     ...
     * BRK     {#}D
     */
    public class Brk_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Brk_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
