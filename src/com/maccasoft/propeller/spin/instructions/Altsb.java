...
public class Altsb extends Spin2PAsmInstructionFactory {
    ...
    public class Altsb_ extends Spin2InstructionObject {
        ...
        public Altsb_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altsb_D_ extends Spin2InstructionObject {
        ...
        public Altsb_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
