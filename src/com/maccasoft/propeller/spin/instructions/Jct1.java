...
public class Jct1 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jct1_(context, condition, arguments.get(0));
        }
     ...
     * JCT1    {#}S
     */
    public class Jct1_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jct1_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
