...
public class Fltnz extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_WCZ.check(arguments, effect)) {
            return new Fltnz_(context, condition, arguments.get(0), effect);
        }
     ...
     * FLTNZ   {#}D           {WCZ}
     */
    public class Fltnz_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;
        String effect;

        public Fltnz_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b001010101);
