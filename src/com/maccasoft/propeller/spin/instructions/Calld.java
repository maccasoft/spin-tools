...
public class Calld extends Spin2PAsmInstructionFactory {
    ...
    public static class Calld_P_A_ extends Spin2InstructionObject {
        ...
        public Calld_P_A_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = r.setBoolean(value, !src.getPrefix().endsWith("\\"));
            value = a.setValue(value, src.getPrefix().endsWith("\\") ? src.getInteger() : (src.getInteger() - context.getSymbol("$").getNumber().intValue() - 1) * 4);
    ...
    public static class Calld_ extends Spin2InstructionObject {
        ...
        public Calld_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.src = src;
