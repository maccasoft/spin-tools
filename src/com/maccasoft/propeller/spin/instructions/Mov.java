...
public class Mov extends Spin2PAsmInstructionFactory {
     ...
     * MOV     D,{#}S   {WC/WZ/WCZ}
     */
    public class Mov_ extends Spin2InstructionObject {
        ...
        public Mov_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
