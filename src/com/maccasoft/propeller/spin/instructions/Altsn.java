...
public class Altsn extends Spin2PAsmInstructionFactory {
    ...
    public class Altsn_ extends Spin2InstructionObject {
        ...
        public Altsn_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altsn_D_ extends Spin2InstructionObject {
        ...
        public Altsn_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
