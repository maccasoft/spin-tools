...
public class Waitint extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.WC_WZ_WCZ.check(arguments, effect)) {
            return new Waitint_(context, condition, effect);
        }
     ...
     * WAITINT          {WC/WZ/WCZ}
     */
    public class Waitint_ extends Spin2InstructionObject {

        String condition;
        String effect;

        public Waitint_(Spin2Context context, String condition, String effect) {
            super(context);
