...
public class Setcq extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Setcq_(context, condition, arguments.get(0));
        }
     ...
     * SETCQ   {#}D
     */
    public class Setcq_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Setcq_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b000111010);
