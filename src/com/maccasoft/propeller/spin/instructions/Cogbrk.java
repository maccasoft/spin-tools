...
public class Cogbrk extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Cogbrk_(context, condition, arguments.get(0));
        }
     ...
     * COGBRK  {#}D
     */
    public class Cogbrk_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Cogbrk_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
