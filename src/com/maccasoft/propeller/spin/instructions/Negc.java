...
public class Negc extends Spin2PAsmInstructionFactory {
    ...
    public class Negc_ extends Spin2InstructionObject {
        ...
        public Negc_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = o.setValue(value, 0b0110100);
    ...
    public class Negc_D_ extends Spin2InstructionObject {
        ...
        public Negc_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
