...
public class Wrbyte extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_S.check(arguments, effect)) {
            return new Wrbyte_(context, condition, arguments.get(0), arguments.get(1));
        }
     ...
     * WRBYTE  {#}D,{#}S/P
     */
    public class Wrbyte_ extends Spin2InstructionObject {
        ...
        public Wrbyte_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
