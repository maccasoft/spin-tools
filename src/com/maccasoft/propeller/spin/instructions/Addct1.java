...
public class Addct1 extends Spin2PAsmInstructionFactory {
    ...
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.D_S.check(arguments, effect)) {
            return new Addct1_(context, condition, arguments.get(0), arguments.get(1));
        }
     ...
     * ADDCT1  D,{#}S
     */
    public class Addct1_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;
        Spin2PAsmExpression src;

        public Addct1_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
