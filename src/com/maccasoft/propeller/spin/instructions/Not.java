...
public class Not extends Spin2PAsmInstructionFactory {
    ...
    public class Not_ extends Spin2InstructionObject {
        ...
        public Not_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = o.setValue(value, 0b0110001);
    ...
    public class Not_D_ extends Spin2InstructionObject {
        ...
        public Not_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
