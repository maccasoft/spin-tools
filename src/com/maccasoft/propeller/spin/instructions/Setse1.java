...
public class Setse1 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Setse1_(context, condition, arguments.get(0));
        }
     ...
     * SETSE1  {#}D
     */
    public class Setse1_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Setse1_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b000100000);
