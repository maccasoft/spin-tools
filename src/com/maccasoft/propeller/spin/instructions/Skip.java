...
public class Skip extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Skip_(context, condition, arguments.get(0));
        }
     ...
     * SKIP    {#}D
     */
    public class Skip_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Skip_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
