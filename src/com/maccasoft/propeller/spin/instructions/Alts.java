...
public class Alts extends Spin2PAsmInstructionFactory {
    ...
    public class Alts_ extends Spin2InstructionObject {
        ...
        public Alts_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Alts_D_ extends Spin2InstructionObject {
        ...
        public Alts_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
