...
public class Pollint extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.WC_WZ_WCZ.check(arguments, effect)) {
            return new Pollint_(context, condition, effect);
        }
     ...
     * POLLINT          {WC/WZ/WCZ}
     */
    public class Pollint_ extends Spin2InstructionObject {

        String condition;
        String effect;

        public Pollint_(Spin2Context context, String condition, String effect) {
            super(context);
