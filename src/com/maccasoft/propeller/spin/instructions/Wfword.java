...
public class Wfword extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Wfword_(context, condition, arguments.get(0));
        }
     ...
     * WFWORD  {#}D
     */
    public class Wfword_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Wfword_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b000010110);
