...
public class Jnatn extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jnatn_(context, condition, arguments.get(0));
        }
     ...
     * JNATN   {#}S
     */
    public class Jnatn_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jnatn_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000011110);
