...
public class Jse4 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jse4_(context, condition, arguments.get(0));
        }
     ...
     * JSE4    {#}S
     */
    public class Jse4_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jse4_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000000111);
