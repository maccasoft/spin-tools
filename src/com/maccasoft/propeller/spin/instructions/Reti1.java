...
public class Reti1 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.NONE.check(arguments, effect)) {
            return new Reti1_(context, condition);
        }
     ...
     * RETI1
     */
    public class Reti1_ extends Spin2InstructionObject {

        String condition;

        public Reti1_(Spin2Context context, String condition) {
            super(context);
