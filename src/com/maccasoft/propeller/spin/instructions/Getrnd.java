...
public class Getrnd extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.WC_WZ_WCZ.check(arguments, effect)) {
            return new Getrnd_(context, condition, effect);
        }
        if (Spin2PAsmSchema.D_WC_WZ_WCZ.check(arguments, effect)) {
            return new Getrnd_D_(context, condition, arguments.get(0), effect);
        }
     ...
     * GETRND            WC/WZ/WCZ
     */
    public class Getrnd_ extends Spin2InstructionObject {

        String condition;
        String effect;

        public Getrnd_(Spin2Context context, String condition, String effect) {
            super(context);
    ...
    public class Getrnd_D_ extends Spin2InstructionObject {
        ...
        public Getrnd_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
