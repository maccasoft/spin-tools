...
public class Jnse1 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jnse1_(context, condition, arguments.get(0));
        }
     ...
     * JNSE1   {#}S
     */
    public class Jnse1_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jnse1_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
