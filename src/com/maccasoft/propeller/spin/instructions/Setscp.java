...
public class Setscp extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Setscp_(context, condition, arguments.get(0));
        }
     ...
     * SETSCP  {#}D
     */
    public class Setscp_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Setscp_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b001110000);
