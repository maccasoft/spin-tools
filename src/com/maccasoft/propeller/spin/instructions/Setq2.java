...
public class Setq2 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD.check(arguments, effect)) {
            return new Setq2_(context, condition, arguments.get(0));
        }
     ...
     * SETQ2   {#}D
     */
    public class Setq2_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;

        public Setq2_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b000101001);
