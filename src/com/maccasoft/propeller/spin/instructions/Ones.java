...
public class Ones extends Spin2PAsmInstructionFactory {
    ...
    public class Ones_ extends Spin2InstructionObject {
        ...
        public Ones_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
    ...
    public class Ones_D_ extends Spin2InstructionObject {
        ...
        public Ones_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
