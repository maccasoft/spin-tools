...
public class Jxfi extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jxfi_(context, condition, arguments.get(0));
        }
     ...
     * JXFI    {#}S
     */
    public class Jxfi_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jxfi_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
