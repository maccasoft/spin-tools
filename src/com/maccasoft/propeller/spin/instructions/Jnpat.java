...
public class Jnpat extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jnpat_(context, condition, arguments.get(0));
        }
     ...
     * JNPAT   {#}S
     */
    public class Jnpat_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jnpat_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
