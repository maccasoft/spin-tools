...
public class Altsw extends Spin2PAsmInstructionFactory {
    ...
    public class Altsw_ extends Spin2InstructionObject {
        ...
        public Altsw_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src) {
            super(context);
    ...
    public class Altsw_D_ extends Spin2InstructionObject {
        ...
        public Altsw_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
