...
public class Jpat extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jpat_(context, condition, arguments.get(0));
        }
     ...
     * JPAT    {#}S
     */
    public class Jpat_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jpat_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000001000);
