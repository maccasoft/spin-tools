...
public class Jct2 extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jct2_(context, condition, arguments.get(0));
        }
     ...
     * JCT2    {#}S
     */
    public class Jct2_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jct2_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000000010);
