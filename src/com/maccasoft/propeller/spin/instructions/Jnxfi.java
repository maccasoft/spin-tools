...
public class Jnxfi extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jnxfi_(context, condition, arguments.get(0));
        }
     ...
     * JNXFI   {#}S
     */
    public class Jnxfi_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jnxfi_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
