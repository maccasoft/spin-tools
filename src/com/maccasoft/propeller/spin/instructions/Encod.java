...
public class Encod extends Spin2PAsmInstructionFactory {
    ...
    public class Encod_ extends Spin2InstructionObject {
        ...
        public Encod_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, String effect) {
            super(context);
    ...
    public class Encod_D_ extends Spin2InstructionObject {
        ...
        public Encod_D_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
            this.condition = condition;
            this.dst = dst;
            this.effect = effect;
