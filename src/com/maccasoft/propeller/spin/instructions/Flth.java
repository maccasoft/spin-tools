...
public class Flth extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.LD_WCZ.check(arguments, effect)) {
            return new Flth_(context, condition, arguments.get(0), effect);
        }
     ...
     * FLTH    {#}D           {WCZ}
     */
    public class Flth_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression dst;
        String effect;

        public Flth_(Spin2Context context, String condition, Spin2PAsmExpression dst, String effect) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = s.setValue(value, 0b001010001);
