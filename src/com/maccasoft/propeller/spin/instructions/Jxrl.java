...
public class Jxrl extends Spin2PAsmInstructionFactory {

    @Override
    public Spin2InstructionObject createObject(Spin2Context context, String condition, List<Spin2PAsmExpression> arguments, String effect) {
        if (Spin2PAsmSchema.S.check(arguments, effect)) {
            return new Jxrl_(context, condition, arguments.get(0));
        }
     ...
     * JXRL    {#}S
     */
    public class Jxrl_ extends Spin2InstructionObject {

        String condition;
        Spin2PAsmExpression src;

        public Jxrl_(Spin2Context context, String condition, Spin2PAsmExpression src) {
            super(context);
        ...
        public byte[] getBytes() {
            ...
            value = d.setValue(value, 0b000001101);
