...
public class Rolbyte extends Spin2PAsmInstructionFactory {
    ...
    public class Rolbyte_ extends Spin2InstructionObject {
        ...
        public Rolbyte_(Spin2Context context, String condition, Spin2PAsmExpression dst, Spin2PAsmExpression src, Spin2PAsmExpression n) {
            super(context);
    ...
    public class Rolbyte_D_ extends Spin2InstructionObject {
        ...
        public Rolbyte_D_(Spin2Context context, String condition, Spin2PAsmExpression dst) {
            super(context);
            this.condition = condition;
            this.dst = dst;
        }
